 ...
 ******************************************************************************/
package es.uah.aut.srg.gss.lang.tcheader.services;
...
@Singleton
public class TCHEADERGrammarAccess extends AbstractGrammarElementFinder {
	
	public class GSSTCHeaderElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheader.TCHEADER.GSSTCHeader");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cGSSTCHeaderKeyword_0 = (Keyword)cGroup.eContents().get(0);
		...
		//'<GSSTCHeader'
		public Keyword getGSSTCHeaderKeyword_0() { return cGSSTCHeaderKeyword_0; }
		...
		//'</GSSTCHeader>'
		public Keyword getGSSTCHeaderKeyword_9() { return cGSSTCHeaderKeyword_9; }
	}
	public class GSSTCHeaderFieldElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheader.TCHEADER.GSSTCHeaderField");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TMTCIFFieldValueRawElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheader.TCHEADER.TMTCIFFieldValueRaw");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final GSSTCHeaderElements pGSSTCHeader;
	private final GSSTCHeaderFieldElements pGSSTCHeaderField;
	...
	@Inject
	public TCHEADERGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pGSSTCHeader = new GSSTCHeaderElements();
		this.pGSSTCHeaderField = new GSSTCHeaderFieldElements();
		this.pTMTCIFFieldValueRaw = new TMTCIFFieldValueRawElements();
		this.tUINT_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheader.TCHEADER.UINT_STRING");
		this.tHEX_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheader.TCHEADER.HEX_STRING");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("es.uah.aut.srg.gss.lang.tcheader.TCHEADER".equals(grammar.getName())) {
				return grammar;
			}
	...
	public ParserRule getGSSTCHeaderRule() {
		return getGSSTCHeaderAccess().getRule();
	}
	...
	//	'gssHeaderField=' gssHeaderField=[format::GSSFormatField|STRING] ('>' fieldValue=TMTCIFFieldValueRaw '</HeaderField>'
	//	| '/>');
	public GSSTCHeaderFieldElements getGSSTCHeaderFieldAccess() {
		return pGSSTCHeaderField;
	}
	
	public ParserRule getGSSTCHeaderFieldRule() {
		return getGSSTCHeaderFieldAccess().getRule();
	}
