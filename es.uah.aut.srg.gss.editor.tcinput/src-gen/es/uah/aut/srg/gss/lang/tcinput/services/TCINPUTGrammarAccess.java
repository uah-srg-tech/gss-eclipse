 ...
 ******************************************************************************/
package es.uah.aut.srg.gss.lang.tcinput.services;
...
@Singleton
public class TCINPUTGrammarAccess extends AbstractGrammarElementFinder {
	
	public class GSSTCInputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcinput.TCINPUT.GSSTCInput");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cGSSTCInputKeyword_0 = (Keyword)cGroup.eContents().get(0);
		...
		private final RuleCall cGssFieldsGSSTCInputFieldParserRuleCall_18_1_0 = (RuleCall)cGssFieldsAssignment_18_1.eContents().get(0);
		private final Keyword cFieldsKeyword_18_2 = (Keyword)cGroup_18.eContents().get(2);
		private final Keyword cGSSTCInputKeyword_19 = (Keyword)cGroup.eContents().get(19);
		...
		//	level0_format=[format::GSSFormatFormat|STRING] '/>')? ('<fields>' gssFields+=GSSTCInputField+ '</fields>')?
		//	'</GSSTCInput>';
		@Override public ParserRule getRule() { return rule; }
		
		//'<GSSTCInput' 'name=' name=STRING 'type=' type=UINT_STRING 'subtype=' subtype=UINT_STRING 'levels=' levels=UINT_STRING
		//'>' ('<to_level3_export' 'file=' to_level3_export=[export::GSSExportExport|STRING] '/>')? ('<level3_format' 'file='
		//level3_format=[format::GSSFormatFormat|STRING] '/>')? ('<to_level2_export' 'file='
		//to_level2_export=[export::GSSExportExport|STRING] '/>')? ('<level2_format' 'file='
		//level2_format=[format::GSSFormatFormat|STRING] '/>')? ('<to_level1_export' 'file='
		...
		//'<GSSTCInput'
		public Keyword getGSSTCInputKeyword_0() { return cGSSTCInputKeyword_0; }
		...
		//('<fields>' gssFields+=GSSTCInputField+ '</fields>')?
		...
		//GSSTCInputField
		public RuleCall getGssFieldsGSSTCInputFieldParserRuleCall_18_1_0() { return cGssFieldsGSSTCInputFieldParserRuleCall_18_1_0; }
		
		//'</fields>'
		public Keyword getFieldsKeyword_18_2() { return cFieldsKeyword_18_2; }
		
		//'</GSSTCInput>'
		public Keyword getGSSTCInputKeyword_19() { return cGSSTCInputKeyword_19; }
	}
	public class GSSTCInputFieldElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcinput.TCINPUT.GSSTCInputField");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//'<InputField' 'name=' name=STRING 'gssField=' gssField=[format::GSSFormatField|STRING] ('enumRef='
	...
	private final GSSTCInputElements pGSSTCInput;
	private final GSSTCInputFieldElements pGSSTCInputField;
	...
	@Inject
	public TCINPUTGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pGSSTCInput = new GSSTCInputElements();
		this.pGSSTCInputField = new GSSTCInputFieldElements();
		this.tUINT_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcinput.TCINPUT.UINT_STRING");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("es.uah.aut.srg.gss.lang.tcinput.TCINPUT".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	level0_format=[format::GSSFormatFormat|STRING] '/>')? ('<fields>' gssFields+=GSSTCInputField+ '</fields>')?
	//	'</GSSTCInput>';
	public GSSTCInputElements getGSSTCInputAccess() {
		return pGSSTCInput;
	}
	
	public ParserRule getGSSTCInputRule() {
		return getGSSTCInputAccess().getRule();
	}
	...
	//	'gssField=' gssField=[format::GSSFormatField|STRING] ('enumRef=' enumRef=[enum_::TMTCIFEnum|STRING])?
	//	'/>';
	public GSSTCInputFieldElements getGSSTCInputFieldAccess() {
		return pGSSTCInputField;
	}
	
	public ParserRule getGSSTCInputFieldRule() {
		return getGSSTCInputFieldAccess().getRule();
	}
