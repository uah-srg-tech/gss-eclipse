 ...
 ******************************************************************************/
package es.uah.aut.srg.gss.lang.import_.services;
...
public class IMPORTGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class GSSModelFileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.GSSModelFile");
	...
	public class GSSModelFileImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.GSSModelFileImport");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GSSImportImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.GSSImportImport");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cFromGSSFormatFormatCrossReference_6_0 = (CrossReference)cFromAssignment_6.eContents().get(0);
		private final RuleCall cFromGSSFormatFormatVersionedQualifiedNameParserRuleCall_6_0_1 = (RuleCall)cFromGSSFormatFormatCrossReference_6_0.eContents().get(1);
		...
		private final CrossReference cToGSSFormatFormatCrossReference_10_1_0 = (CrossReference)cToAssignment_10_1.eContents().get(0);
		private final RuleCall cToGSSFormatFormatVersionedQualifiedNameParserRuleCall_10_1_0_1 = (RuleCall)cToGSSFormatFormatCrossReference_10_1_0.eContents().get(1);
		...
		//'GSSImportImport' name=ID '{' ('uri' ':=' uri=QualifiedName ';' & 'version' ':=' version=Version ';') 'from' ':='
		//from=[format::GSSFormatFormat|VersionedQualifiedName] ';' 'to' ':=' ('NULL' |
		//to=[format::GSSFormatFormat|VersionedQualifiedName]) ';' dataSource+=GSSImportDataSource+
		//virtualSize=GSSImportVirtualSize? '}' ';'
		public Group getGroup() { return cGroup; }
		...
		public CrossReference getFromGSSFormatFormatCrossReference_6_0() { return cFromGSSFormatFormatCrossReference_6_0; }
		
		//VersionedQualifiedName
		public RuleCall getFromGSSFormatFormatVersionedQualifiedNameParserRuleCall_6_0_1() { return cFromGSSFormatFormatVersionedQualifiedNameParserRuleCall_6_0_1; }
		...
		//('NULL' | to=[format::GSSFormatFormat|VersionedQualifiedName])
		...
		//[format::GSSFormatFormat|VersionedQualifiedName]
		public CrossReference getToGSSFormatFormatCrossReference_10_1_0() { return cToGSSFormatFormatCrossReference_10_1_0; }
		
		//VersionedQualifiedName
		public RuleCall getToGSSFormatFormatVersionedQualifiedNameParserRuleCall_10_1_0_1() { return cToGSSFormatFormatVersionedQualifiedNameParserRuleCall_10_1_0_1; }
	...
	public class GSSImportDataSourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.GSSImportDataSource");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//'GSSImportDataSource' '{' 'FieldRef' ':=' FieldRef=[format::GSSFormatField|VersionedQualifiedReferenceName] ';'
	...
	public class GSSImportVirtualSizeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.GSSImportVirtualSize");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cToGSSFormatFieldCrossReference_8_0 = (CrossReference)cToAssignment_8.eContents().get(0);
		private final RuleCall cToGSSFormatFieldVersionedQualifiedReferenceNameParserRuleCall_8_0_1 = (RuleCall)cToGSSFormatFieldCrossReference_8_0.eContents().get(1);
		private final Keyword cSemicolonKeyword_9 = (Keyword)cGroup.eContents().get(9);
		...
		//	'GSSImportVirtualSize' '{'
		//	'FieldRef' ':=' FieldRef=[format::GSSFormatField|VersionedQualifiedReferenceName] ';'
		//	'to' ':=' to=[format::GSSFormatField|VersionedQualifiedReferenceName] ';' ('addSize' ':=' addSize=INTEGER ';')?
		//	('unit' ':=' unit=GSSImportUnit ';')?
		//	'}' ';';
		@Override public ParserRule getRule() { return rule; }
		
		//'GSSImportVirtualSize' '{' 'FieldRef' ':=' FieldRef=[format::GSSFormatField|VersionedQualifiedReferenceName] ';' 'to'
		//':=' to=[format::GSSFormatField|VersionedQualifiedReferenceName] ';' ('addSize' ':=' addSize=INTEGER ';')? ('unit'
		//':=' unit=GSSImportUnit ';')? '}' ';'
		public Group getGroup() { return cGroup; }
		...
		//to=[format::GSSFormatField|VersionedQualifiedReferenceName]
		public Assignment getToAssignment_8() { return cToAssignment_8; }
		
		//[format::GSSFormatField|VersionedQualifiedReferenceName]
		public CrossReference getToGSSFormatFieldCrossReference_8_0() { return cToGSSFormatFieldCrossReference_8_0; }
		
		//VersionedQualifiedReferenceName
		public RuleCall getToGSSFormatFieldVersionedQualifiedReferenceNameParserRuleCall_8_0_1() { return cToGSSFormatFieldVersionedQualifiedReferenceNameParserRuleCall_8_0_1; }
	...
	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.QualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VersionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.Version");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VersionedQualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.VersionedQualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VersionedQualifiedReferenceNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.VersionedQualifiedReferenceName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class INTEGERElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.INTEGER");
	...
	public class GSSImportUnitElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.GSSImportUnit");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public IMPORTGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tHEXADECIMAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.import_.IMPORT.HEXADECIMAL");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("es.uah.aut.srg.gss.lang.import_.IMPORT".equals(grammar.getName())) {
				return grammar;
			}
