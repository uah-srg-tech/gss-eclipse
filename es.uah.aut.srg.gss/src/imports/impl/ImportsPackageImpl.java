...
import imports.GSSImportUnit;
import imports.GSSImportVirtualSize;
import imports.ImportsFactory;
...
public class ImportsPackageImpl extends EPackageImpl implements ImportsPackage {
	 ...
	 * @see imports.ImportsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getGSSImportImport_VirtualSize(), this.getGSSImportVirtualSize(), null, "virtualSize", null, 1, 1, GSSImportImport.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
