...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Format Formula</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.format.impl.GSSFormatFormulaImpl#getSlope <em>Slope</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.format.impl.GSSFormatFormulaImpl#getIntercept <em>Intercept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFormatFormulaImpl extends MinimalEObjectImpl.Container implements GSSFormatFormula {
	/**
	 ...
	 * @generated
	 */
	protected GSSFormatFormulaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return formatPackage.Literals.GSS_FORMAT_FORMULA;
	}
	...
	public void setSlope(String newSlope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formatPackage.GSS_FORMAT_FORMULA__SLOPE, oldSlope, slope));
	}
	...
	public void setIntercept(String newIntercept) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formatPackage.GSS_FORMAT_FORMULA__INTERCEPT, oldIntercept, intercept));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case formatPackage.GSS_FORMAT_FORMULA__SLOPE:
				return getSlope();
			case formatPackage.GSS_FORMAT_FORMULA__INTERCEPT:
				return getIntercept();
		}
