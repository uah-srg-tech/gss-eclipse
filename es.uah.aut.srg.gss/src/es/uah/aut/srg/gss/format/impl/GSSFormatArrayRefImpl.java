...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Format Array Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.format.impl.GSSFormatArrayRefImpl#getFidRef <em>Fid Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFormatArrayRefImpl extends MinimalEObjectImpl.Container implements GSSFormatArrayRef {
	/**
	 ...
	 * @generated
	 */
	protected GSSFormatArrayRefImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return formatPackage.Literals.GSS_FORMAT_ARRAY_REF;
	}
	...
	public void setFidRef(String newFidRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formatPackage.GSS_FORMAT_ARRAY_REF__FID_REF, oldFidRef, fidRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case formatPackage.GSS_FORMAT_ARRAY_REF__FID_REF:
				return getFidRef();
		}
