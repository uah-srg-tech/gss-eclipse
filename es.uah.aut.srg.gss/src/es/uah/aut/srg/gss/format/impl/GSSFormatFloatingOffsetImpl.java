...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Format Floating Offset</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.format.impl.GSSFormatFloatingOffsetImpl#getFidRef <em>Fid Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFormatFloatingOffsetImpl extends MinimalEObjectImpl.Container implements GSSFormatFloatingOffset {
	/**
	 ...
	 * @generated
	 */
	protected GSSFormatFloatingOffsetImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return formatPackage.Literals.GSS_FORMAT_FLOATING_OFFSET;
	}
	...
	public void setFidRef(String newFidRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formatPackage.GSS_FORMAT_FLOATING_OFFSET__FID_REF, oldFidRef, fidRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case formatPackage.GSS_FORMAT_FLOATING_OFFSET__FID_REF:
				return getFidRef();
		}
