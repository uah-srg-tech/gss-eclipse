 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filter.GSSFilterValue#getValue <em>Value</em>}</li>
...
public interface GSSFilterValue extends EObject {
	 ...
	 * @see #setValue(String)
	 * @see es.uah.aut.srg.gss.filter.filterPackage#getGSSFilterValue_Value()
	 * @model
	 * @generated
	 */
	String getValue();
	...
	/**
	 * Sets the value of the '{@link es.uah.aut.srg.gss.filter.GSSFilterValue#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
