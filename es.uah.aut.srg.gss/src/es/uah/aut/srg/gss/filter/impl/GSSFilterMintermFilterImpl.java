 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filter.impl.GSSFilterMintermFilterImpl#getMinterm <em>Minterm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFilterMintermFilterImpl extends GSSFilterFilterImpl implements GSSFilterMintermFilter {
	...
	protected EClass eStaticClass() {
		return filterPackage.Literals.GSS_FILTER_MINTERM_FILTER;
	}
	...
	public EList<GSSFilterMinterm> getMinterm() {
		if (minterm == null) {
			minterm = new EObjectContainmentEList<GSSFilterMinterm>(GSSFilterMinterm.class, this, filterPackage.GSS_FILTER_MINTERM_FILTER__MINTERM);
		}
		return minterm;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case filterPackage.GSS_FILTER_MINTERM_FILTER__MINTERM:
