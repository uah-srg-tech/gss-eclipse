 ...
 *   <li>{@link es.uah.aut.srg.gss.filter.impl.GSSFilterConstantImpl#getMask <em>Mask</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFilterConstantImpl extends MinimalEObjectImpl.Container implements GSSFilterConstant {
	...
	public void setMask(String newMask) {
		...
		mask = newMask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, filterPackage.GSS_FILTER_CONSTANT__MASK, oldMask, mask));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case filterPackage.GSS_FILTER_CONSTANT__VALUE:
				return getValue();
			case filterPackage.GSS_FILTER_CONSTANT__MASK:
				return getMask();
		}
