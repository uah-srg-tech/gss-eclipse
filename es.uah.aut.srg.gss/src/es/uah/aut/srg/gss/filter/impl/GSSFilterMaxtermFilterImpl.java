 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filter.impl.GSSFilterMaxtermFilterImpl#getMaxterm <em>Maxterm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFilterMaxtermFilterImpl extends GSSFilterFilterImpl implements GSSFilterMaxtermFilter {
	...
	protected EClass eStaticClass() {
		return filterPackage.Literals.GSS_FILTER_MAXTERM_FILTER;
	}
	...
	public EList<GSSFilterMaxterm> getMaxterm() {
		if (maxterm == null) {
			maxterm = new EObjectContainmentEList<GSSFilterMaxterm>(GSSFilterMaxterm.class, this, filterPackage.GSS_FILTER_MAXTERM_FILTER__MAXTERM);
		}
		return maxterm;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case filterPackage.GSS_FILTER_MAXTERM_FILTER__MAXTERM:
