 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filter.impl.GSSFilterBoolVarRefImpl#getIdRef <em>Id Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFilterBoolVarRefImpl extends MinimalEObjectImpl.Container implements GSSFilterBoolVarRef {
	...
	protected EClass eStaticClass() {
		return filterPackage.Literals.GSS_FILTER_BOOL_VAR_REF;
	}
	...
	public void setIdRef(String newIdRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, filterPackage.GSS_FILTER_BOOL_VAR_REF__ID_REF, oldIdRef, idRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case filterPackage.GSS_FILTER_BOOL_VAR_REF__ID_REF:
				return getIdRef();
		}
