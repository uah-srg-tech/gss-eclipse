...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSSTM Output Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.tmoutput.impl.GSSTMOutputFieldImpl#getGssField <em>Gss Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTMOutputFieldImpl extends TMTCIFTMFieldImpl implements GSSTMOutputField {
	/**
	 ...
	 * @generated
	 */
	protected GSSTMOutputFieldImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return tmoutputPackage.Literals.GSSTM_OUTPUT_FIELD;
	}
		...
		if (gssField != null && gssField.eIsProxy()) {
			...
			if (gssField != oldGssField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tmoutputPackage.GSSTM_OUTPUT_FIELD__GSS_FIELD, oldGssField, gssField));
			}
		}
		return gssField;
	}
	...
	public void setGssField(GSSFormatField newGssField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tmoutputPackage.GSSTM_OUTPUT_FIELD__GSS_FIELD, oldGssField, gssField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case tmoutputPackage.GSSTM_OUTPUT_FIELD__GSS_FIELD:
