...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Scenario Periodic TC Level0</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioPeriodicTCLevel0Impl#getLevel0 <em>Level0</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioPeriodicTCLevel0Impl#getApp_to_level0 <em>App to level0</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSScenarioPeriodicTCLevel0Impl extends GSSScenarioPeriodicTCImpl implements GSSScenarioPeriodicTCLevel0 {
	/**
	 ...
	 * @generated
	 */
	protected GSSScenarioPeriodicTCLevel0Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return scenarioPackage.Literals.GSS_SCENARIO_PERIODIC_TC_LEVEL0;
	}
		...
		if (level0 != null && level0.eIsProxy()) {
			...
			if (level0 != oldLevel0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL0__LEVEL0, oldLevel0, level0));
			}
		}
		return level0;
	}
	...
	public void setLevel0(GSSFormatFormat newLevel0) {
		...
		level0 = newLevel0;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL0__LEVEL0, oldLevel0, level0));
	}
	...
	public GSSExportExport getApp_to_level0() {
		if (app_to_level0 != null && app_to_level0.eIsProxy()) {
			...
			if (app_to_level0 != oldApp_to_level0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL0__APP_TO_LEVEL0, oldApp_to_level0, app_to_level0));
			}
		}
	...
	public void setApp_to_level0(GSSExportExport newApp_to_level0) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL0__APP_TO_LEVEL0, oldApp_to_level0, app_to_level0));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL0__LEVEL0:
				if (resolve) return getLevel0();
				return basicGetLevel0();
			case scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL0__APP_TO_LEVEL0:
...
} //GSSScenarioPeriodicTCLevel0Impl
