 ...
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioReferenceSpecialPacketImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioReferenceSpecialPacketImpl#getFieldRef <em>Field Ref</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioReferenceSpecialPacketImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioReferenceSpecialPacketImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSScenarioReferenceSpecialPacketImpl extends MinimalEObjectImpl.Container implements GSSScenarioReferenceSpecialPacket {
	/**
	...
	public void setLevel(String newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__LEVEL, oldLevel, level));
	}
	...
	public void setFieldRef(String newFieldRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__FIELD_REF, oldFieldRef, fieldRef));
	}
	...
	public void setOffset(String newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__OFFSET, oldOffset, offset));
	}
	...
	public void setSize(String newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__SIZE, oldSize, size));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__LEVEL:
				return getLevel();
			case scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__FIELD_REF:
				return getFieldRef();
			case scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__OFFSET:
				return getOffset();
			case scenarioPackage.GSS_SCENARIO_REFERENCE_SPECIAL_PACKET__SIZE:
				return getSize();
		}
