...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Scenario Periodic TC Level1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioPeriodicTCLevel1Impl#getLevel1 <em>Level1</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioPeriodicTCLevel1Impl#getApp_to_level1 <em>App to level1</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioPeriodicTCLevel1Impl#getLevel0 <em>Level0</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.scenario.impl.GSSScenarioPeriodicTCLevel1Impl#getLevel1_to_level0 <em>Level1 to level0</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSScenarioPeriodicTCLevel1Impl extends GSSScenarioPeriodicTCImpl implements GSSScenarioPeriodicTCLevel1 {
	/**
	 ...
	 * @generated
	 */
	protected GSSScenarioPeriodicTCLevel1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return scenarioPackage.Literals.GSS_SCENARIO_PERIODIC_TC_LEVEL1;
	}
		...
		if (level1 != null && level1.eIsProxy()) {
			...
			if (level1 != oldLevel1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL1, oldLevel1, level1));
			}
		}
		return level1;
	}
	...
	public void setLevel1(GSSFormatFormat newLevel1) {
		...
		level1 = newLevel1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL1, oldLevel1, level1));
	}
	...
	public GSSExportExport getApp_to_level1() {
		if (app_to_level1 != null && app_to_level1.eIsProxy()) {
			...
			if (app_to_level1 != oldApp_to_level1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__APP_TO_LEVEL1, oldApp_to_level1, app_to_level1));
			}
		}
	...
	public void setApp_to_level1(GSSExportExport newApp_to_level1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__APP_TO_LEVEL1, oldApp_to_level1, app_to_level1));
	}
	...
	public GSSFormatFormat getLevel0() {
		if (level0 != null && level0.eIsProxy()) {
			...
			if (level0 != oldLevel0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL0, oldLevel0, level0));
			}
		}
		return level0;
	}
	...
	public void setLevel0(GSSFormatFormat newLevel0) {
		...
		level0 = newLevel0;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL0, oldLevel0, level0));
	}
	...
	public GSSExportExport getLevel1_to_level0() {
		if (level1_to_level0 != null && level1_to_level0.eIsProxy()) {
			...
			if (level1_to_level0 != oldLevel1_to_level0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL1_TO_LEVEL0, oldLevel1_to_level0, level1_to_level0));
			}
		}
	...
	public void setLevel1_to_level0(GSSExportExport newLevel1_to_level0) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL1_TO_LEVEL0, oldLevel1_to_level0, level1_to_level0));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL1:
				if (resolve) return getLevel1();
				return basicGetLevel1();
			case scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__APP_TO_LEVEL1:
				if (resolve) return getApp_to_level1();
				return basicGetApp_to_level1();
			case scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL0:
				if (resolve) return getLevel0();
				return basicGetLevel0();
			case scenarioPackage.GSS_SCENARIO_PERIODIC_TC_LEVEL1__LEVEL1_TO_LEVEL0:
...
} //GSSScenarioPeriodicTCLevel1Impl
