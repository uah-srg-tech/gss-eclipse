...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSSTC Input</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getLevels <em>Levels</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getTo_level3_export <em>To level3 export</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getLevel3_format <em>Level3 format</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getTo_level2_export <em>To level2 export</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getLevel2_format <em>Level2 format</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getTo_level1_export <em>To level1 export</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getLevel1_format <em>Level1 format</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getTo_level0_export <em>To level0 export</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getLevel0_format <em>Level0 format</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tcinput.impl.GSSTCInputImpl#getGssFields <em>Gss Fields</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTCInputImpl extends TMTCIFTCImpl implements GSSTCInput {
	/**
	 ...
	 * @ordered
	 */
	protected EList<GSSTCInputField> gssFields;
	...
	protected EClass eStaticClass() {
		return tcinputPackage.Literals.GSSTC_INPUT;
	}
	...
	public void setLevels(String newLevels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__LEVELS, oldLevels, levels));
	}
	...
	public GSSExportExport getTo_level3_export() {
		if (to_level3_export != null && to_level3_export.eIsProxy()) {
			...
			if (to_level3_export != oldTo_level3_export) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__TO_LEVEL3_EXPORT, oldTo_level3_export, to_level3_export));
			}
		}
	...
	public void setTo_level3_export(GSSExportExport newTo_level3_export) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__TO_LEVEL3_EXPORT, oldTo_level3_export, to_level3_export));
	}
	...
	public GSSFormatFormat getLevel3_format() {
		if (level3_format != null && level3_format.eIsProxy()) {
			...
			if (level3_format != oldLevel3_format) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__LEVEL3_FORMAT, oldLevel3_format, level3_format));
			}
		}
	...
	public void setLevel3_format(GSSFormatFormat newLevel3_format) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__LEVEL3_FORMAT, oldLevel3_format, level3_format));
	}
	...
	public GSSExportExport getTo_level2_export() {
		if (to_level2_export != null && to_level2_export.eIsProxy()) {
			...
			if (to_level2_export != oldTo_level2_export) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__TO_LEVEL2_EXPORT, oldTo_level2_export, to_level2_export));
			}
		}
	...
	public void setTo_level2_export(GSSExportExport newTo_level2_export) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__TO_LEVEL2_EXPORT, oldTo_level2_export, to_level2_export));
	}
	...
	public GSSFormatFormat getLevel2_format() {
		if (level2_format != null && level2_format.eIsProxy()) {
			...
			if (level2_format != oldLevel2_format) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__LEVEL2_FORMAT, oldLevel2_format, level2_format));
			}
		}
	...
	public void setLevel2_format(GSSFormatFormat newLevel2_format) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__LEVEL2_FORMAT, oldLevel2_format, level2_format));
	}
	...
	public GSSExportExport getTo_level1_export() {
		if (to_level1_export != null && to_level1_export.eIsProxy()) {
			...
			if (to_level1_export != oldTo_level1_export) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__TO_LEVEL1_EXPORT, oldTo_level1_export, to_level1_export));
			}
		}
	...
	public void setTo_level1_export(GSSExportExport newTo_level1_export) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__TO_LEVEL1_EXPORT, oldTo_level1_export, to_level1_export));
	}
	...
	public GSSFormatFormat getLevel1_format() {
		if (level1_format != null && level1_format.eIsProxy()) {
			...
			if (level1_format != oldLevel1_format) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__LEVEL1_FORMAT, oldLevel1_format, level1_format));
			}
		}
	...
	public void setLevel1_format(GSSFormatFormat newLevel1_format) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__LEVEL1_FORMAT, oldLevel1_format, level1_format));
	}
	...
	public GSSExportExport getTo_level0_export() {
		if (to_level0_export != null && to_level0_export.eIsProxy()) {
			...
			if (to_level0_export != oldTo_level0_export) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__TO_LEVEL0_EXPORT, oldTo_level0_export, to_level0_export));
			}
		}
	...
	public void setTo_level0_export(GSSExportExport newTo_level0_export) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__TO_LEVEL0_EXPORT, oldTo_level0_export, to_level0_export));
	}
	...
	public GSSFormatFormat getLevel0_format() {
		if (level0_format != null && level0_format.eIsProxy()) {
			...
			if (level0_format != oldLevel0_format) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcinputPackage.GSSTC_INPUT__LEVEL0_FORMAT, oldLevel0_format, level0_format));
			}
		}
	...
	public void setLevel0_format(GSSFormatFormat newLevel0_format) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcinputPackage.GSSTC_INPUT__LEVEL0_FORMAT, oldLevel0_format, level0_format));
	}
	 ...
	 * @generated
	 */
	public EList<GSSTCInputField> getGssFields() {
		if (gssFields == null) {
			gssFields = new EObjectContainmentEList<GSSTCInputField>(GSSTCInputField.class, this, tcinputPackage.GSSTC_INPUT__GSS_FIELDS);
		}
		return gssFields;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case tcinputPackage.GSSTC_INPUT__GSS_FIELDS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case tcinputPackage.GSSTC_INPUT__GSS_FIELDS:
				getGssFields().clear();
				getGssFields().addAll((Collection<? extends GSSTCInputField>)newValue);
				return;
		}
	...
	public EList<TMTCIFTCField> getFields() {
		...
		for(GSSTCInputField gssField : getGssFields()) {
