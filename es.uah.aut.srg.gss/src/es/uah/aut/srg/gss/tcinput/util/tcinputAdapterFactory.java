 ...
 * @generated
 */
public class tcinputAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected tcinputSwitch<Adapter> modelSwitch =
		new tcinputSwitch<Adapter>() {
			@Override
			public Adapter caseGSSTCInput(GSSTCInput object) {
				return createGSSTCInputAdapter();
			}
			@Override
			public Adapter caseGSSTCInputField(GSSTCInputField object) {
				return createGSSTCInputFieldAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.gss.tcinput.GSSTCInput <em>GSSTC Input</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGSSTCInputAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.gss.tcinput.GSSTCInputField <em>GSSTC Input Field</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGSSTCInputFieldAdapter() {
		return null;
	}
