...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Iface Const Size</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.iface.impl.GSSIfaceConstSizeImpl#getBytes <em>Bytes</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.iface.impl.GSSIfaceConstSizeImpl#getBits <em>Bits</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSIfaceConstSizeImpl extends MinimalEObjectImpl.Container implements GSSIfaceConstSize {
	/**
	 ...
	 * @generated
	 */
	protected GSSIfaceConstSizeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ifacePackage.Literals.GSS_IFACE_CONST_SIZE;
	}
	...
	public void setBytes(String newBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ifacePackage.GSS_IFACE_CONST_SIZE__BYTES, oldBytes, bytes));
	}
	...
	public void setBits(String newBits) {
		...
		bits = newBits;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ifacePackage.GSS_IFACE_CONST_SIZE__BITS, oldBits, bits));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ifacePackage.GSS_IFACE_CONST_SIZE__BYTES:
				return getBytes();
			case ifacePackage.GSS_IFACE_CONST_SIZE__BITS:
				return getBits();
		}
