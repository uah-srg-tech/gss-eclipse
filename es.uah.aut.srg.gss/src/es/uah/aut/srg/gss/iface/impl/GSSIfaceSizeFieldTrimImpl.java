...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Iface Size Field Trim</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.iface.impl.GSSIfaceSizeFieldTrimImpl#getBytes <em>Bytes</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.iface.impl.GSSIfaceSizeFieldTrimImpl#getBits <em>Bits</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSIfaceSizeFieldTrimImpl extends MinimalEObjectImpl.Container implements GSSIfaceSizeFieldTrim {
	/**
	 ...
	 * @generated
	 */
	protected GSSIfaceSizeFieldTrimImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ifacePackage.Literals.GSS_IFACE_SIZE_FIELD_TRIM;
	}
	...
	public void setBytes(String newBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ifacePackage.GSS_IFACE_SIZE_FIELD_TRIM__BYTES, oldBytes, bytes));
	}
	...
	public void setBits(String newBits) {
		...
		bits = newBits;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ifacePackage.GSS_IFACE_SIZE_FIELD_TRIM__BITS, oldBits, bits));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ifacePackage.GSS_IFACE_SIZE_FIELD_TRIM__BYTES:
				return getBytes();
			case ifacePackage.GSS_IFACE_SIZE_FIELD_TRIM__BITS:
				return getBits();
		}
