...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Iface Socket Srv Port</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.iface.impl.GSSIfaceSocketSrvPortImpl#getPortNumber <em>Port Number</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.iface.impl.GSSIfaceSocketSrvPortImpl#getPortProtocol <em>Port Protocol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSIfaceSocketSrvPortImpl extends GSSIfacePortImpl implements GSSIfaceSocketSrvPort {
	/**
	 ...
	 * @generated
	 */
	protected GSSIfaceSocketSrvPortImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ifacePackage.Literals.GSS_IFACE_SOCKET_SRV_PORT;
	}
	...
	public void setPortNumber(String newPortNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ifacePackage.GSS_IFACE_SOCKET_SRV_PORT__PORT_NUMBER, oldPortNumber, portNumber));
	}
	...
	public NotificationChain basicSetPortProtocol(GSSIfacePortProtocol newPortProtocol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ifacePackage.GSS_IFACE_SOCKET_SRV_PORT__PORT_PROTOCOL, oldPortProtocol, newPortProtocol);
	...
	public void setPortProtocol(GSSIfacePortProtocol newPortProtocol) {
		if (newPortProtocol != portProtocol) {
			...
			if (portProtocol != null)
				msgs = ((InternalEObject)portProtocol).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ifacePackage.GSS_IFACE_SOCKET_SRV_PORT__PORT_PROTOCOL, null, msgs);
			if (newPortProtocol != null)
				msgs = ((InternalEObject)newPortProtocol).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ifacePackage.GSS_IFACE_SOCKET_SRV_PORT__PORT_PROTOCOL, null, msgs);
			msgs = basicSetPortProtocol(newPortProtocol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ifacePackage.GSS_IFACE_SOCKET_SRV_PORT__PORT_PROTOCOL, newPortProtocol, newPortProtocol));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ifacePackage.GSS_IFACE_SOCKET_SRV_PORT__PORT_PROTOCOL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ifacePackage.GSS_IFACE_SOCKET_SRV_PORT__PORT_NUMBER:
