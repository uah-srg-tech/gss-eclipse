...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Environment Structured Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentStructuredDataImpl#getLevelRef <em>Level Ref</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentStructuredDataImpl#getFirstField <em>First Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSEnvironmentStructuredDataImpl extends MinimalEObjectImpl.Container implements GSSEnvironmentStructuredData {
	/**
	 ...
	 * @generated
	 */
	protected GSSEnvironmentStructuredDataImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return environmentPackage.Literals.GSS_ENVIRONMENT_STRUCTURED_DATA;
	}
	...
	public void setLevelRef(String newLevelRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_STRUCTURED_DATA__LEVEL_REF, oldLevelRef, levelRef));
	}
	...
	public void setFirstField(String newFirstField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_STRUCTURED_DATA__FIRST_FIELD, oldFirstField, firstField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case environmentPackage.GSS_ENVIRONMENT_STRUCTURED_DATA__LEVEL_REF:
				return getLevelRef();
			case environmentPackage.GSS_ENVIRONMENT_STRUCTURED_DATA__FIRST_FIELD:
...
} //GSSEnvironmentStructuredDataImpl
