...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Environment Periodic TC</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentPeriodicTCImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentPeriodicTCImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentPeriodicTCImpl#getIfRef <em>If Ref</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentPeriodicTCImpl#getPeriod_value <em>Period value</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentPeriodicTCImpl#getPeriod_unit <em>Period unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSEnvironmentPeriodicTCImpl extends MinimalEObjectImpl.Container implements GSSEnvironmentPeriodicTC {
	/**
	 ...
	 * @generated
	 */
	protected GSSEnvironmentPeriodicTCImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return environmentPackage.Literals.GSS_ENVIRONMENT_PERIODIC_TC;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__NAME, oldName, name));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__ID, oldId, id));
	}
	...
	public void setIfRef(String newIfRef) {
		...
		ifRef = newIfRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__IF_REF, oldIfRef, ifRef));
	}
	...
	public void setPeriod_value(String newPeriod_value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__PERIOD_VALUE, oldPeriod_value, period_value));
	}
	...
	public void setPeriod_unit(GSSEnvironmentUnit newPeriod_unit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__PERIOD_UNIT, oldPeriod_unit, period_unit, !oldPeriod_unitESet));
	}
	...
	public void unsetPeriod_unit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__PERIOD_UNIT, oldPeriod_unit, PERIOD_UNIT_EDEFAULT, oldPeriod_unitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__NAME:
				return getName();
			case environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__ID:
				return getId();
			case environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__IF_REF:
				return getIfRef();
			case environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__PERIOD_VALUE:
				return getPeriod_value();
			case environmentPackage.GSS_ENVIRONMENT_PERIODIC_TC__PERIOD_UNIT:
