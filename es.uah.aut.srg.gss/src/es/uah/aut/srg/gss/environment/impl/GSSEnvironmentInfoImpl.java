...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Environment Info</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentInfoImpl#getTest_campaign <em>Test campaign</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentInfoImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentInfoImpl#getDate <em>Date</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentInfoImpl#getVersion_control_url <em>Version control url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSEnvironmentInfoImpl extends MinimalEObjectImpl.Container implements GSSEnvironmentInfo {
	/**
	 ...
	 * @generated
	 */
	protected GSSEnvironmentInfoImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return environmentPackage.Literals.GSS_ENVIRONMENT_INFO;
	}
	...
	public void setTest_campaign(String newTest_campaign) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_INFO__TEST_CAMPAIGN, oldTest_campaign, test_campaign));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_INFO__VERSION, oldVersion, version));
	}
	...
	public void setDate(String newDate) {
		...
		date = newDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_INFO__DATE, oldDate, date));
	}
	...
	public void setVersion_control_url(String newVersion_control_url) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_INFO__VERSION_CONTROL_URL, oldVersion_control_url, version_control_url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case environmentPackage.GSS_ENVIRONMENT_INFO__TEST_CAMPAIGN:
				return getTest_campaign();
			case environmentPackage.GSS_ENVIRONMENT_INFO__VERSION:
				return getVersion();
			case environmentPackage.GSS_ENVIRONMENT_INFO__DATE:
				return getDate();
			case environmentPackage.GSS_ENVIRONMENT_INFO__VERSION_CONTROL_URL:
