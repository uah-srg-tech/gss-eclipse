...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Environment Level Out</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentLevelOutImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentLevelOutImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentLevelOutImpl#getTMformat <em>TMformat</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentLevelOutImpl#getInputFilter <em>Input Filter</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentLevelOutImpl#getImport_from_prev_Level <em>Import from prev Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSEnvironmentLevelOutImpl extends MinimalEObjectImpl.Container implements GSSEnvironmentLevelOut {
	/**
	 ...
	 * @generated
	 */
	protected GSSEnvironmentLevelOutImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return environmentPackage.Literals.GSS_ENVIRONMENT_LEVEL_OUT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__ID, oldId, id, !oldIdESet));
	}
	...
	public void unsetId() {
		...
		idESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__ID, oldId, ID_EDEFAULT, oldIdESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__NAME, oldName, name));
	}
	...
	public TMTCIFFormatFormat getTMformat() {
		if (tMformat != null && tMformat.eIsProxy()) {
			...
			if (tMformat != oldTMformat) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__TMFORMAT, oldTMformat, tMformat));
			}
		}
		return tMformat;
	}
	...
	public void setTMformat(TMTCIFFormatFormat newTMformat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__TMFORMAT, oldTMformat, tMformat));
	}
	...
	public TMTCIFFilterFilter getInputFilter() {
		if (inputFilter != null && inputFilter.eIsProxy()) {
			...
			if (inputFilter != oldInputFilter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__INPUT_FILTER, oldInputFilter, inputFilter));
			}
		}
		return inputFilter;
	}
	...
	public void setInputFilter(TMTCIFFilterFilter newInputFilter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__INPUT_FILTER, oldInputFilter, inputFilter));
	}
	...
	public TMTCIFImportImport getImport_from_prev_Level() {
		if (import_from_prev_Level != null && import_from_prev_Level.eIsProxy()) {
			...
			if (import_from_prev_Level != oldImport_from_prev_Level) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__IMPORT_FROM_PREV_LEVEL, oldImport_from_prev_Level, import_from_prev_Level));
			}
		}
	...
	public void setImport_from_prev_Level(TMTCIFImportImport newImport_from_prev_Level) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__IMPORT_FROM_PREV_LEVEL, oldImport_from_prev_Level, import_from_prev_Level));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__ID:
				return getId();
			case environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__NAME:
				return getName();
			case environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__TMFORMAT:
				if (resolve) return getTMformat();
				return basicGetTMformat();
			case environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__INPUT_FILTER:
				if (resolve) return getInputFilter();
				return basicGetInputFilter();
			case environmentPackage.GSS_ENVIRONMENT_LEVEL_OUT__IMPORT_FROM_PREV_LEVEL:
