...
public class environmentPackageImpl extends EPackageImpl implements environmentPackage {
	 ...
	 * @generated
	 */
	private EClass gssEnvironmentProtocolTypeEClass = null;
	 ...
	 * @generated
	 */
	public EReference getGSSEnvironmentProtocol_Type() {
		return (EReference)gssEnvironmentProtocolEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getGSSEnvironmentProtocol_Subtype() {
		return (EReference)gssEnvironmentProtocolEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EClass getGSSEnvironmentProtocolType() {
		return gssEnvironmentProtocolTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getGSSEnvironmentProtocolType_Offset() {
		return (EAttribute)gssEnvironmentProtocolTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getGSSEnvironmentProtocolType_Name() {
		return (EAttribute)gssEnvironmentProtocolTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(gssEnvironmentProtocolEClass, GSS_ENVIRONMENT_PROTOCOL__TYPE);
		createEReference(gssEnvironmentProtocolEClass, GSS_ENVIRONMENT_PROTOCOL__SUBTYPE);

		gssEnvironmentProtocolTypeEClass = createEClass(GSS_ENVIRONMENT_PROTOCOL_TYPE);
		createEAttribute(gssEnvironmentProtocolTypeEClass, GSS_ENVIRONMENT_PROTOCOL_TYPE__OFFSET);
		createEAttribute(gssEnvironmentProtocolTypeEClass, GSS_ENVIRONMENT_PROTOCOL_TYPE__NAME);
	...
	public void initializePackageContents() {
		...
		initEReference(getGSSEnvironmentProtocol_Type(), this.getGSSEnvironmentProtocolType(), null, "type", null, 1, 1, GSSEnvironmentProtocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentProtocol_Subtype(), this.getGSSEnvironmentProtocolType(), null, "subtype", null, 0, 1, GSSEnvironmentProtocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(gssEnvironmentProtocolTypeEClass, GSSEnvironmentProtocolType.class, "GSSEnvironmentProtocolType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGSSEnvironmentProtocolType_Offset(), ecorePackage.getEString(), "offset", null, 1, 1, GSSEnvironmentProtocolType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGSSEnvironmentProtocolType_Name(), ecorePackage.getEString(), "name", null, 1, 1, GSSEnvironmentProtocolType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentLevelInOut_TMformat(), theformatPackage.getGSSFormatFormat(), null, "TMformat", null, 1, 1, GSSEnvironmentLevelInOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentLevelInOut_TCformat(), theformatPackage.getGSSFormatFormat(), null, "TCformat", null, 1, 1, GSSEnvironmentLevelInOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentLevelInOut_InputFilter(), thefilterPackage.getGSSFilterFilter(), null, "inputFilter", null, 1, 1, GSSEnvironmentLevelInOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentLevelInOut_Export_to_prev_Level(), theexportPackage.getGSSExportExport(), null, "export_to_prev_Level", null, 0, 1, GSSEnvironmentLevelInOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentLevelInOut_Import_from_prev_Level(), theimportPackage.getGSSImportImport(), null, "import_from_prev_Level", null, 0, 1, GSSEnvironmentLevelInOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentLevelIn_TCformat(), theformatPackage.getGSSFormatFormat(), null, "TCformat", null, 1, 1, GSSEnvironmentLevelIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentLevelIn_Export_to_prev_Level(), theexportPackage.getGSSExportExport(), null, "export_to_prev_Level", null, 0, 1, GSSEnvironmentLevelIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentLevelOut_TMformat(), theformatPackage.getGSSFormatFormat(), null, "TMformat", null, 1, 1, GSSEnvironmentLevelOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentLevelOut_InputFilter(), thefilterPackage.getGSSFilterFilter(), null, "inputFilter", null, 1, 1, GSSEnvironmentLevelOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentLevelOut_Import_from_prev_Level(), theimportPackage.getGSSImportImport(), null, "import_from_prev_Level", null, 0, 1, GSSEnvironmentLevelOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentSpecialPacket_InputFilter(), thefilterPackage.getGSSFilterFilter(), null, "inputFilter", null, 1, 1, GSSEnvironmentSpecialPacket.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentUpperLevel_TMformat(), theformatPackage.getGSSFormatFormat(), null, "TMformat", null, 1, 1, GSSEnvironmentUpperLevel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentUpperLevel_InputFilter(), thefilterPackage.getGSSFilterFilter(), null, "inputFilter", null, 0, 1, GSSEnvironmentUpperLevel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentUpperLevel_Import_from_prev_Level(), theimportPackage.getGSSImportImport(), null, "import_from_prev_Level", null, 0, 1, GSSEnvironmentUpperLevel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentPeriodicTCLevel2_Level2(), theformatPackage.getGSSFormatFormat(), null, "level2", null, 0, 1, GSSEnvironmentPeriodicTCLevel2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel2_App_to_level2(), theexportPackage.getGSSExportExport(), null, "app_to_level2", null, 1, 1, GSSEnvironmentPeriodicTCLevel2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel2_Level1(), theformatPackage.getGSSFormatFormat(), null, "level1", null, 0, 1, GSSEnvironmentPeriodicTCLevel2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel2_Level2_to_level1(), theexportPackage.getGSSExportExport(), null, "level2_to_level1", null, 0, 1, GSSEnvironmentPeriodicTCLevel2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel2_Level0(), theformatPackage.getGSSFormatFormat(), null, "level0", null, 0, 1, GSSEnvironmentPeriodicTCLevel2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel2_Level1_to_level0(), theexportPackage.getGSSExportExport(), null, "level1_to_level0", null, 0, 1, GSSEnvironmentPeriodicTCLevel2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentPeriodicTCLevel1_Level1(), theformatPackage.getGSSFormatFormat(), null, "level1", null, 0, 1, GSSEnvironmentPeriodicTCLevel1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel1_App_to_level1(), theexportPackage.getGSSExportExport(), null, "app_to_level1", null, 1, 1, GSSEnvironmentPeriodicTCLevel1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel1_Level0(), theformatPackage.getGSSFormatFormat(), null, "level0", null, 0, 1, GSSEnvironmentPeriodicTCLevel1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel1_Level1_to_level0(), theexportPackage.getGSSExportExport(), null, "level1_to_level0", null, 0, 1, GSSEnvironmentPeriodicTCLevel1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentPeriodicTCLevel0_Level0(), theformatPackage.getGSSFormatFormat(), null, "level0", null, 0, 1, GSSEnvironmentPeriodicTCLevel0.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGSSEnvironmentPeriodicTCLevel0_App_to_level0(), theexportPackage.getGSSExportExport(), null, "app_to_level0", null, 1, 1, GSSEnvironmentPeriodicTCLevel0.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGSSEnvironmentGVFiltered_Filter(), thefilterPackage.getGSSFilterFilter(), null, "filter", null, 0, 1, GSSEnvironmentGVFiltered.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
