...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Environment Info Print</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentInfoPrintImpl#getMainLog <em>Main Log</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentInfoPrintImpl#getPortLogs <em>Port Logs</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.environment.impl.GSSEnvironmentInfoPrintImpl#getRawLog <em>Raw Log</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSEnvironmentInfoPrintImpl extends MinimalEObjectImpl.Container implements GSSEnvironmentInfoPrint {
	/**
	 ...
	 * @generated
	 */
	protected GSSEnvironmentInfoPrintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return environmentPackage.Literals.GSS_ENVIRONMENT_INFO_PRINT;
	}
	...
	public void setMainLog(GSSEnvironmentEnableDisable newMainLog) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__MAIN_LOG, oldMainLog, mainLog, !oldMainLogESet));
	}
	...
	public void unsetMainLog() {
		...
		mainLogESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__MAIN_LOG, oldMainLog, MAIN_LOG_EDEFAULT, oldMainLogESet));
	}
	...
	public void setPortLogs(GSSEnvironmentEnableDisable newPortLogs) {
		...
		portLogsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__PORT_LOGS, oldPortLogs, portLogs, !oldPortLogsESet));
	}
	...
	public void unsetPortLogs() {
		...
		portLogsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__PORT_LOGS, oldPortLogs, PORT_LOGS_EDEFAULT, oldPortLogsESet));
	}
	...
	public void setRawLog(GSSEnvironmentEnableDisable newRawLog) {
		...
		rawLogESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__RAW_LOG, oldRawLog, rawLog, !oldRawLogESet));
	}
	...
	public void unsetRawLog() {
		...
		rawLogESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__RAW_LOG, oldRawLog, RAW_LOG_EDEFAULT, oldRawLogESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__MAIN_LOG:
				return getMainLog();
			case environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__PORT_LOGS:
				return getPortLogs();
			case environmentPackage.GSS_ENVIRONMENT_INFO_PRINT__RAW_LOG:
				return getRawLog();
		}
