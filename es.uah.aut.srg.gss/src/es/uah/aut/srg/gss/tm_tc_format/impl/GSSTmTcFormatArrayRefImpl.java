...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Tm Tc Format Array Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.tm_tc_format.impl.GSSTmTcFormatArrayRefImpl#getFidRef <em>Fid Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTmTcFormatArrayRefImpl extends MinimalEObjectImpl.Container implements GSSTmTcFormatArrayRef {
	/**
	 ...
	 * @generated
	 */
	protected GSSTmTcFormatArrayRefImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return tm_tc_formatPackage.Literals.GSS_TM_TC_FORMAT_ARRAY_REF;
	}
	...
	public void setFidRef(String newFidRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_ARRAY_REF__FID_REF, oldFidRef, fidRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case tm_tc_formatPackage.GSS_TM_TC_FORMAT_ARRAY_REF__FID_REF:
				return getFidRef();
		}
