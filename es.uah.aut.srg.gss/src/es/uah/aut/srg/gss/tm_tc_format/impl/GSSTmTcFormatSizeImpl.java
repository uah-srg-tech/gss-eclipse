...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Tm Tc Format Size</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.tm_tc_format.impl.GSSTmTcFormatSizeImpl#getBytes <em>Bytes</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tm_tc_format.impl.GSSTmTcFormatSizeImpl#getBits <em>Bits</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTmTcFormatSizeImpl extends MinimalEObjectImpl.Container implements GSSTmTcFormatSize {
	/**
	 ...
	 * @generated
	 */
	protected GSSTmTcFormatSizeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return tm_tc_formatPackage.Literals.GSS_TM_TC_FORMAT_SIZE;
	}
	...
	public void setBytes(String newBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_SIZE__BYTES, oldBytes, bytes));
	}
	...
	public void setBits(String newBits) {
		...
		bits = newBits;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_SIZE__BITS, oldBits, bits));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case tm_tc_formatPackage.GSS_TM_TC_FORMAT_SIZE__BYTES:
				return getBytes();
			case tm_tc_formatPackage.GSS_TM_TC_FORMAT_SIZE__BITS:
				return getBits();
		}
