...
public class GSSTmTcFormatAFieldImpl extends MinimalEObjectImpl.Container implements GSSTmTcFormatAField {
	...
	public void setType(GSSTmTcFormatFieldType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_AFIELD__TYPE, oldType, type));
	}
	...
	public void setByteOrder(GSSTmTcFormatFieldByteOrder newByteOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_AFIELD__BYTE_ORDER, oldByteOrder, byteOrder));
	}
	...
	public void setFirstBit(GSSTmTcFormatSFieldFirstBit newFirstBit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_AFIELD__FIRST_BIT, oldFirstBit, firstBit));
	}
