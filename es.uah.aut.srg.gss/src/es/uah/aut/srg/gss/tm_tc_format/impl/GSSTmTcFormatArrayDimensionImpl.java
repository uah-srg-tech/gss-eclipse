...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Tm Tc Format Array Dimension</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.tm_tc_format.impl.GSSTmTcFormatArrayDimensionImpl#getFidRef <em>Fid Ref</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.tm_tc_format.impl.GSSTmTcFormatArrayDimensionImpl#getMaxItems <em>Max Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTmTcFormatArrayDimensionImpl extends MinimalEObjectImpl.Container implements GSSTmTcFormatArrayDimension {
	/**
	 ...
	 * @generated
	 */
	protected GSSTmTcFormatArrayDimensionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return tm_tc_formatPackage.Literals.GSS_TM_TC_FORMAT_ARRAY_DIMENSION;
	}
	...
	public void setFidRef(String newFidRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_ARRAY_DIMENSION__FID_REF, oldFidRef, fidRef));
	}
	...
	public void setMaxItems(String newMaxItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tm_tc_formatPackage.GSS_TM_TC_FORMAT_ARRAY_DIMENSION__MAX_ITEMS, oldMaxItems, maxItems));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case tm_tc_formatPackage.GSS_TM_TC_FORMAT_ARRAY_DIMENSION__FID_REF:
				return getFidRef();
			case tm_tc_formatPackage.GSS_TM_TC_FORMAT_ARRAY_DIMENSION__MAX_ITEMS:
				return getMaxItems();
		}
...
} //GSSTmTcFormatArrayDimensionImpl
