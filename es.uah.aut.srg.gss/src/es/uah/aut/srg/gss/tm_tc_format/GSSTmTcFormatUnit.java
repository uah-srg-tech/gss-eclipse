...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>GSS Tm Tc Format Unit</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see es.uah.aut.srg.gss.tm_tc_format.tm_tc_formatPackage#getGSSTmTcFormatUnit()
 * @model
 * @generated
 */
public enum GSSTmTcFormatUnit implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>GSS Tm Tc Format Unit</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final GSSTmTcFormatUnit[] VALUES_ARRAY =
		new GSSTmTcFormatUnit[] {
			BYTES,
			BITS,
			HALFWORD,
			STRING10,
	...
	/**
	 * A public read-only list of all the '<em><b>GSS Tm Tc Format Unit</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<GSSTmTcFormatUnit> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>GSS Tm Tc Format Unit</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static GSSTmTcFormatUnit get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GSSTmTcFormatUnit result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>GSS Tm Tc Format Unit</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static GSSTmTcFormatUnit getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GSSTmTcFormatUnit result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>GSS Tm Tc Format Unit</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static GSSTmTcFormatUnit get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private GSSTmTcFormatUnit(int value, String name, String literal) {
		this.value = value;
		this.name = name;
