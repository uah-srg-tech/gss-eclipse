...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Test Proc Level2 Filter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.test_proc.impl.GSSTestProcLevel2FilterImpl#getApply_def_filter <em>Apply def filter</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.test_proc.impl.GSSTestProcLevel2FilterImpl#getExtra_filter <em>Extra filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTestProcLevel2FilterImpl extends MinimalEObjectImpl.Container implements GSSTestProcLevel2Filter {
	/**
	 ...
	 * @generated
	 */
	protected GSSTestProcLevel2FilterImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return test_procPackage.Literals.GSS_TEST_PROC_LEVEL2_FILTER;
	}
	...
	public void setApply_def_filter(GSSTestProcYesNo newApply_def_filter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_LEVEL2_FILTER__APPLY_DEF_FILTER, oldApply_def_filter, apply_def_filter, !oldApply_def_filterESet));
	}
	...
	public void unsetApply_def_filter() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, test_procPackage.GSS_TEST_PROC_LEVEL2_FILTER__APPLY_DEF_FILTER, oldApply_def_filter, APPLY_DEF_FILTER_EDEFAULT, oldApply_def_filterESet));
	}
	...
	public GSSFilterFilter getExtra_filter() {
		if (extra_filter != null && extra_filter.eIsProxy()) {
			...
			if (extra_filter != oldExtra_filter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, test_procPackage.GSS_TEST_PROC_LEVEL2_FILTER__EXTRA_FILTER, oldExtra_filter, extra_filter));
			}
		}
		return extra_filter;
	}
	...
	public void setExtra_filter(GSSFilterFilter newExtra_filter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_LEVEL2_FILTER__EXTRA_FILTER, oldExtra_filter, extra_filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case test_procPackage.GSS_TEST_PROC_LEVEL2_FILTER__APPLY_DEF_FILTER:
				return getApply_def_filter();
			case test_procPackage.GSS_TEST_PROC_LEVEL2_FILTER__EXTRA_FILTER:
