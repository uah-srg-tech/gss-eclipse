...
public class GSSTestProcLevel1FilterImpl extends MinimalEObjectImpl.Container implements GSSTestProcLevel1Filter {
	...
	public void setApply_def_filter(GSSTestProcYesNo newApply_def_filter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_LEVEL1_FILTER__APPLY_DEF_FILTER, oldApply_def_filter, apply_def_filter, !oldApply_def_filterESet));
	}
	...
	public void unsetApply_def_filter() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, test_procPackage.GSS_TEST_PROC_LEVEL1_FILTER__APPLY_DEF_FILTER, oldApply_def_filter, APPLY_DEF_FILTER_EDEFAULT, oldApply_def_filterESet));
	}
	...
	public GSSFilterFilter getExtra_filter() {
		if (extra_filter != null && extra_filter.eIsProxy()) {
			...
			if (extra_filter != oldExtra_filter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, test_procPackage.GSS_TEST_PROC_LEVEL1_FILTER__EXTRA_FILTER, oldExtra_filter, extra_filter));
			}
		}
		return extra_filter;
	}
