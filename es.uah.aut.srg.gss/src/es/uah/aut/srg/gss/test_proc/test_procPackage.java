...
public interface test_procPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int GSS_TEST_PROC_TEST_PROC__SCENARIO = commonPackage.GSS_MODEL_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the attribute '{@link es.uah.aut.srg.gss.test_proc.GSSTestProcTestProc#getScenario <em>Scenario</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Scenario</em>'.
	 * @see es.uah.aut.srg.gss.test_proc.GSSTestProcTestProc#getScenario()
	 * @see #getGSSTestProcTestProc()
	 * @generated
	 */
	EAttribute getGSSTestProcTestProc_Scenario();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute GSS_TEST_PROC_TEST_PROC__SCENARIO = eINSTANCE.getGSSTestProcTestProc_Scenario();
