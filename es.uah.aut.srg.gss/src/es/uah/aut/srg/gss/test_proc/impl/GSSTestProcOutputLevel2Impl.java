...
public class GSSTestProcOutputLevel2Impl extends GSSTestProcOutputImpl implements GSSTestProcOutputLevel2 {
	...
	public NotificationChain basicSetLevel2(GSSTestProcLevel2 newLevel2, NotificationChain msgs) {
		...
		level2 = newLevel2;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2, oldLevel2, newLevel2);
	...
	public void setLevel2(GSSTestProcLevel2 newLevel2) {
		if (newLevel2 != level2) {
			...
			if (level2 != null)
				msgs = ((InternalEObject)level2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2, null, msgs);
			if (newLevel2 != null)
				msgs = ((InternalEObject)newLevel2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2, null, msgs);
			msgs = basicSetLevel2(newLevel2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2, newLevel2, newLevel2));
	}
	...
	public NotificationChain basicSetLevel1(GSSTestProcLevel1 newLevel1, NotificationChain msgs) {
		...
		level1 = newLevel1;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1, oldLevel1, newLevel1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLevel1(GSSTestProcLevel1 newLevel1) {
		if (newLevel1 != level1) {
			NotificationChain msgs = null;
			if (level1 != null)
				msgs = ((InternalEObject)level1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1, null, msgs);
			if (newLevel1 != null)
				msgs = ((InternalEObject)newLevel1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1, null, msgs);
			msgs = basicSetLevel1(newLevel1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1, newLevel1, newLevel1));
	}
	...
	public NotificationChain basicSetLevel2_from_level1(GSSTestProcLevel2FromLevel1 newLevel2_from_level1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2_FROM_LEVEL1, oldLevel2_from_level1, newLevel2_from_level1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLevel2_from_level1(GSSTestProcLevel2FromLevel1 newLevel2_from_level1) {
		if (newLevel2_from_level1 != level2_from_level1) {
			...
			if (level2_from_level1 != null)
				msgs = ((InternalEObject)level2_from_level1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2_FROM_LEVEL1, null, msgs);
			if (newLevel2_from_level1 != null)
				msgs = ((InternalEObject)newLevel2_from_level1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2_FROM_LEVEL1, null, msgs);
			msgs = basicSetLevel2_from_level1(newLevel2_from_level1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL2_FROM_LEVEL1, newLevel2_from_level1, newLevel2_from_level1));
	}
	...
	public NotificationChain basicSetLevel0(GSSTestProcLevel0 newLevel0, NotificationChain msgs) {
		...
		level0 = newLevel0;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL0, oldLevel0, newLevel0);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLevel0(GSSTestProcLevel0 newLevel0) {
		if (newLevel0 != level0) {
			NotificationChain msgs = null;
			if (level0 != null)
				msgs = ((InternalEObject)level0).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL0, null, msgs);
			if (newLevel0 != null)
				msgs = ((InternalEObject)newLevel0).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL0, null, msgs);
			msgs = basicSetLevel0(newLevel0, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL0, newLevel0, newLevel0));
	}
	...
	public NotificationChain basicSetLevel1_from_level0(GSSTestProcLevel1FromLevel0 newLevel1_from_level0, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1_FROM_LEVEL0, oldLevel1_from_level0, newLevel1_from_level0);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLevel1_from_level0(GSSTestProcLevel1FromLevel0 newLevel1_from_level0) {
		if (newLevel1_from_level0 != level1_from_level0) {
			...
			if (level1_from_level0 != null)
				msgs = ((InternalEObject)level1_from_level0).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1_FROM_LEVEL0, null, msgs);
			if (newLevel1_from_level0 != null)
				msgs = ((InternalEObject)newLevel1_from_level0).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1_FROM_LEVEL0, null, msgs);
			msgs = basicSetLevel1_from_level0(newLevel1_from_level0, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, test_procPackage.GSS_TEST_PROC_OUTPUT_LEVEL2__LEVEL1_FROM_LEVEL0, newLevel1_from_level0, newLevel1_from_level0));
	}
