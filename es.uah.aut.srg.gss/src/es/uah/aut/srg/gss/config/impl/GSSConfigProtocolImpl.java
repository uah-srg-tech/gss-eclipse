...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Config Protocol</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigProtocolImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigProtocolImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigProtocolImpl#getTypeLevel <em>Type Level</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigProtocolImpl#getTypeOffset <em>Type Offset</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigProtocolImpl#getSubtypeOffset <em>Subtype Offset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSConfigProtocolImpl extends MinimalEObjectImpl.Container implements GSSConfigProtocol {
	/**
	 ...
	 * @generated
	 */
	protected GSSConfigProtocolImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return configPackage.Literals.GSS_CONFIG_PROTOCOL;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PROTOCOL__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PROTOCOL__NAME, oldName, name));
	}
	...
	public void setTypeLevel(String newTypeLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PROTOCOL__TYPE_LEVEL, oldTypeLevel, typeLevel));
	}
	...
	public void setTypeOffset(String newTypeOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PROTOCOL__TYPE_OFFSET, oldTypeOffset, typeOffset));
	}
	...
	public void setSubtypeOffset(String newSubtypeOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PROTOCOL__SUBTYPE_OFFSET, oldSubtypeOffset, subtypeOffset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case configPackage.GSS_CONFIG_PROTOCOL__ID:
				return getId();
			case configPackage.GSS_CONFIG_PROTOCOL__NAME:
				return getName();
			case configPackage.GSS_CONFIG_PROTOCOL__TYPE_LEVEL:
				return getTypeLevel();
			case configPackage.GSS_CONFIG_PROTOCOL__TYPE_OFFSET:
				return getTypeOffset();
			case configPackage.GSS_CONFIG_PROTOCOL__SUBTYPE_OFFSET:
