...
public class configFactoryImpl extends EFactoryImpl implements configFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case configPackage.GSS_CONFIG_CONFIG: return createGSSConfigConfig();
	 ...
	 * @generated
	 */
	public GSSConfigConfig createGSSConfigConfig() {
		GSSConfigConfigImpl gssConfigConfig = new GSSConfigConfigImpl();
		return gssConfigConfig;
	}
