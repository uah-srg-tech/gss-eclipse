...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Config Alarm Val</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigAlarmValImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigAlarmValImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigAlarmValImpl#getGVFiltered <em>GV Filtered</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigAlarmValImpl#getGVPeriodic <em>GV Periodic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSConfigAlarmValImpl extends MinimalEObjectImpl.Container implements GSSConfigAlarmVal {
	/**
	 ...
	 * @ordered
	 */
	protected static final GSSConfigAlarmValType TYPE_EDEFAULT = GSSConfigAlarmValType.ALARM1;
	 ...
	 * @generated
	 */
	protected GSSConfigAlarmValImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return configPackage.Literals.GSS_CONFIG_ALARM_VAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_ALARM_VAL__NAME, oldName, name));
	}
	 ...
	 * @generated
	 */
	public GSSConfigAlarmValType getType() {
		return type;
	}
	...
	public NotificationChain basicSetGVFiltered(GSSConfigGVFiltered newGVFiltered, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_ALARM_VAL__GV_FILTERED, oldGVFiltered, newGVFiltered);
	...
	public void setGVFiltered(GSSConfigGVFiltered newGVFiltered) {
		if (newGVFiltered != gvFiltered) {
			...
			if (gvFiltered != null)
				msgs = ((InternalEObject)gvFiltered).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - configPackage.GSS_CONFIG_ALARM_VAL__GV_FILTERED, null, msgs);
			if (newGVFiltered != null)
				msgs = ((InternalEObject)newGVFiltered).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - configPackage.GSS_CONFIG_ALARM_VAL__GV_FILTERED, null, msgs);
			msgs = basicSetGVFiltered(newGVFiltered, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_ALARM_VAL__GV_FILTERED, newGVFiltered, newGVFiltered));
	}
	...
	public NotificationChain basicSetGVPeriodic(GSSConfigGVPeriodic newGVPeriodic, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_ALARM_VAL__GV_PERIODIC, oldGVPeriodic, newGVPeriodic);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGVPeriodic(GSSConfigGVPeriodic newGVPeriodic) {
		if (newGVPeriodic != gvPeriodic) {
			NotificationChain msgs = null;
			if (gvPeriodic != null)
				msgs = ((InternalEObject)gvPeriodic).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - configPackage.GSS_CONFIG_ALARM_VAL__GV_PERIODIC, null, msgs);
			if (newGVPeriodic != null)
				msgs = ((InternalEObject)newGVPeriodic).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - configPackage.GSS_CONFIG_ALARM_VAL__GV_PERIODIC, null, msgs);
			msgs = basicSetGVPeriodic(newGVPeriodic, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_ALARM_VAL__GV_PERIODIC, newGVPeriodic, newGVPeriodic));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case configPackage.GSS_CONFIG_ALARM_VAL__NAME:
				...
				return;
			case configPackage.GSS_CONFIG_ALARM_VAL__TYPE:
				setType((GSSConfigAlarmValType)newValue);
				return;
			case configPackage.GSS_CONFIG_ALARM_VAL__GV_FILTERED:
