...
public class configSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case configPackage.GSS_CONFIG_CONFIG: {
				GSSConfigConfig gssConfigConfig = (GSSConfigConfig)theEObject;
				T result = caseGSSConfigConfig(gssConfigConfig);
				if (result == null) result = caseGSSModelElement(gssConfigConfig);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GSS Config Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GSS Config Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGSSConfigConfig(GSSConfigConfig object) {
		return null;
	}
