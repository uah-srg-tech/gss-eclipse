...
public interface configPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link es.uah.aut.srg.gss.config.impl.GSSConfigConfigImpl <em>GSS Config Config</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see es.uah.aut.srg.gss.config.impl.GSSConfigConfigImpl
	 * @see es.uah.aut.srg.gss.config.impl.configPackageImpl#getGSSConfigConfig()
	 * @generated
	 */
	int GSS_CONFIG_CONFIG = 0;
	 ...
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG__NAME = commonPackage.GSS_MODEL_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG__URI = commonPackage.GSS_MODEL_ELEMENT__URI;
	 ...
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG__VERSION = commonPackage.GSS_MODEL_ELEMENT__VERSION;
	 ...
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG__DESCRIPTION = commonPackage.GSS_MODEL_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG__SCENARIO = commonPackage.GSS_MODEL_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG__TESTS = commonPackage.GSS_MODEL_ELEMENT_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>GSS Config Config</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG_FEATURE_COUNT = commonPackage.GSS_MODEL_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>GSS Config Config</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GSS_CONFIG_CONFIG_OPERATION_COUNT = commonPackage.GSS_MODEL_ELEMENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link es.uah.aut.srg.gss.config.GSSConfigConfig <em>GSS Config Config</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>GSS Config Config</em>'.
	 * @see es.uah.aut.srg.gss.config.GSSConfigConfig
	 * @generated
	 */
	EClass getGSSConfigConfig();

	/**
	 * Returns the meta object for the reference '{@link es.uah.aut.srg.gss.config.GSSConfigConfig#getScenario <em>Scenario</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Scenario</em>'.
	 * @see es.uah.aut.srg.gss.config.GSSConfigConfig#getScenario()
	 * @see #getGSSConfigConfig()
	 * @generated
	 */
	EReference getGSSConfigConfig_Scenario();

	/**
	 * Returns the meta object for the containment reference '{@link es.uah.aut.srg.gss.config.GSSConfigConfig#getTests <em>Tests</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Tests</em>'.
	 * @see es.uah.aut.srg.gss.config.GSSConfigConfig#getTests()
	 * @see #getGSSConfigConfig()
	 * @generated
	 */
	EReference getGSSConfigConfig_Tests();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link es.uah.aut.srg.gss.config.impl.GSSConfigConfigImpl <em>GSS Config Config</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see es.uah.aut.srg.gss.config.impl.GSSConfigConfigImpl
		 * @see es.uah.aut.srg.gss.config.impl.configPackageImpl#getGSSConfigConfig()
		 * @generated
		 */
		EClass GSS_CONFIG_CONFIG = eINSTANCE.getGSSConfigConfig();
		 ...
		 * @generated
		 */
		EReference GSS_CONFIG_CONFIG__SCENARIO = eINSTANCE.getGSSConfigConfig_Scenario();
		 ...
		 * @generated
		 */
		EReference GSS_CONFIG_CONFIG__TESTS = eINSTANCE.getGSSConfigConfig_Tests();
