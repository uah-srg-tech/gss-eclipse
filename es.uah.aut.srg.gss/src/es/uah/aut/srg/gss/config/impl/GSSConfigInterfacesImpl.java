 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigInterfacesImpl#getProtocolPacketsFile <em>Protocol Packets File</em>}</li>
...
public class GSSConfigInterfacesImpl extends MinimalEObjectImpl.Container implements GSSConfigInterfaces {
	...
	public GSSProtocolPacketsProtocolPackets getProtocolPacketsFile() {
		if (protocolPacketsFile != null && protocolPacketsFile.eIsProxy()) {
			...
			if (protocolPacketsFile != oldProtocolPacketsFile) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, configPackage.GSS_CONFIG_INTERFACES__PROTOCOL_PACKETS_FILE, oldProtocolPacketsFile, protocolPacketsFile));
			}
		}
	...
	public void setProtocolPacketsFile(GSSProtocolPacketsProtocolPackets newProtocolPacketsFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_INTERFACES__PROTOCOL_PACKETS_FILE, oldProtocolPacketsFile, protocolPacketsFile));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case configPackage.GSS_CONFIG_INTERFACES__PROTOCOL_PACKETS_FILE:
