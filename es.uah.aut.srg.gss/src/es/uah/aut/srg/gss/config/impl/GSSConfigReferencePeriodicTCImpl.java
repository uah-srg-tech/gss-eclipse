...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Config Reference Periodic TC</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigReferencePeriodicTCImpl#getIdRef <em>Id Ref</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigReferencePeriodicTCImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigReferencePeriodicTCImpl#getFieldRef <em>Field Ref</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigReferencePeriodicTCImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigReferencePeriodicTCImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSConfigReferencePeriodicTCImpl extends MinimalEObjectImpl.Container implements GSSConfigReferencePeriodicTC {
	 ...
	 * @generated
	 */
	protected GSSConfigReferencePeriodicTCImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return configPackage.Literals.GSS_CONFIG_REFERENCE_PERIODIC_TC;
	}
	...
	public void setLevel(String newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_REFERENCE_PERIODIC_TC__LEVEL, oldLevel, level));
	}
	...
	public void setFieldRef(String newFieldRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_REFERENCE_PERIODIC_TC__FIELD_REF, oldFieldRef, fieldRef));
	}
	...
	public void setOffset(String newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_REFERENCE_PERIODIC_TC__OFFSET, oldOffset, offset));
	}
	...
	public void setSize(String newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_REFERENCE_PERIODIC_TC__SIZE, oldSize, size));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case configPackage.GSS_CONFIG_REFERENCE_PERIODIC_TC__FIELD_REF:
				return getFieldRef();
			case configPackage.GSS_CONFIG_REFERENCE_PERIODIC_TC__OFFSET:
				return getOffset();
			case configPackage.GSS_CONFIG_REFERENCE_PERIODIC_TC__SIZE:
				return getSize();
		}
...
} //GSSConfigReferencePeriodicTCImpl
