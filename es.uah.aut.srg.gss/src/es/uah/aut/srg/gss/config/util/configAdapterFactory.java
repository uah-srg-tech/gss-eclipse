...
public class configAdapterFactory extends AdapterFactoryImpl {
	...
	protected configSwitch<Adapter> modelSwitch =
		new configSwitch<Adapter>() {
			@Override
			public Adapter caseGSSConfigConfig(GSSConfigConfig object) {
				return createGSSConfigConfigAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.gss.config.GSSConfigConfig <em>GSS Config Config</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGSSConfigConfigAdapter() {
		return null;
	}
