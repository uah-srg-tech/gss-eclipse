...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Config Periodic TC</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigPeriodicTCImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigPeriodicTCImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigPeriodicTCImpl#getIfRef <em>If Ref</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigPeriodicTCImpl#getPeriod_value <em>Period value</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.config.impl.GSSConfigPeriodicTCImpl#getPeriod_unit <em>Period unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSConfigPeriodicTCImpl extends MinimalEObjectImpl.Container implements GSSConfigPeriodicTC {
	/**
	 ...
	 * @generated
	 */
	protected GSSConfigPeriodicTCImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return configPackage.Literals.GSS_CONFIG_PERIODIC_TC;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PERIODIC_TC__NAME, oldName, name));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PERIODIC_TC__ID, oldId, id));
	}
	...
	public void setIfRef(String newIfRef) {
		...
		ifRef = newIfRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PERIODIC_TC__IF_REF, oldIfRef, ifRef));
	}
	...
	public void setPeriod_value(String newPeriod_value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PERIODIC_TC__PERIOD_VALUE, oldPeriod_value, period_value));
	}
	...
	public void setPeriod_unit(GSSConfigUnit newPeriod_unit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, configPackage.GSS_CONFIG_PERIODIC_TC__PERIOD_UNIT, oldPeriod_unit, period_unit, !oldPeriod_unitESet));
	}
	...
	public void unsetPeriod_unit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, configPackage.GSS_CONFIG_PERIODIC_TC__PERIOD_UNIT, oldPeriod_unit, PERIOD_UNIT_EDEFAULT, oldPeriod_unitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case configPackage.GSS_CONFIG_PERIODIC_TC__NAME:
				return getName();
			case configPackage.GSS_CONFIG_PERIODIC_TC__ID:
				return getId();
			case configPackage.GSS_CONFIG_PERIODIC_TC__IF_REF:
				return getIfRef();
			case configPackage.GSS_CONFIG_PERIODIC_TC__PERIOD_VALUE:
				return getPeriod_value();
			case configPackage.GSS_CONFIG_PERIODIC_TC__PERIOD_UNIT:
