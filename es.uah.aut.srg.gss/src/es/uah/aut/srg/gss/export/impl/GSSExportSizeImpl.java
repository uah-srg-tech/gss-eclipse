...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSS Export Size</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.export.impl.GSSExportSizeImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.export.impl.GSSExportSizeImpl#getAddSize <em>Add Size</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.export.impl.GSSExportSizeImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSExportSizeImpl extends MinimalEObjectImpl.Container implements GSSExportSize {
	...
	protected EClass eStaticClass() {
		return exportPackage.Literals.GSS_EXPORT_SIZE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, exportPackage.GSS_EXPORT_SIZE__ID, oldId, id));
	}
	...
	public void setAddSize(String newAddSize) {
		...
		addSize = newAddSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, exportPackage.GSS_EXPORT_SIZE__ADD_SIZE, oldAddSize, addSize));
	}
	...
	public void setUnit(GSSExportUnit newUnit) {
		...
		unitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, exportPackage.GSS_EXPORT_SIZE__UNIT, oldUnit, unit, !oldUnitESet));
	}
	...
	public void unsetUnit() {
		...
		unitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, exportPackage.GSS_EXPORT_SIZE__UNIT, oldUnit, UNIT_EDEFAULT, oldUnitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case exportPackage.GSS_EXPORT_SIZE__ID:
				return getId();
			case exportPackage.GSS_EXPORT_SIZE__ADD_SIZE:
				return getAddSize();
			case exportPackage.GSS_EXPORT_SIZE__UNIT:
				return getUnit();
		}
