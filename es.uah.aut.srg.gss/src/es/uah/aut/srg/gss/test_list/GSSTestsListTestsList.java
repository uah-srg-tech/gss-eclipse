...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>GSS Tests List Tests List</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.test_list.GSSTestsListTestsList#getTestCase <em>Test Case</em>}</li>
 * </ul>
 *
 * @see es.uah.aut.srg.gss.test_list.test_listPackage#getGSSTestsListTestsList()
 * @model
 * @generated
 */
public interface GSSTestsListTestsList extends EObject {
	/**
	 ...
	 * @see es.uah.aut.srg.gss.test_list.test_listPackage#getGSSTestsListTestsList_TestCase()
	 * @model containment="true" required="true" upper="150"
	 * @generated
	 */
	EList<GSSTestListTestCase> getTestCase();

} // GSSTestsListTestsList
