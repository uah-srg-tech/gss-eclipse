...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSSTM Header Output Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.tmheaderoutput.impl.GSSTMHeaderOutputFieldImpl#getGssHeaderField <em>Gss Header Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTMHeaderOutputFieldImpl extends TMTCIFTMHeaderFieldImpl implements GSSTMHeaderOutputField {
	/**
	 ...
	 * @generated
	 */
	protected GSSTMHeaderOutputFieldImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return tmheaderoutputPackage.Literals.GSSTM_HEADER_OUTPUT_FIELD;
	}
		...
		if (gssHeaderField != null && gssHeaderField.eIsProxy()) {
			...
			if (gssHeaderField != oldGssHeaderField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tmheaderoutputPackage.GSSTM_HEADER_OUTPUT_FIELD__GSS_HEADER_FIELD, oldGssHeaderField, gssHeaderField));
			}
		}
	...
	public void setGssHeaderField(GSSFormatField newGssHeaderField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tmheaderoutputPackage.GSSTM_HEADER_OUTPUT_FIELD__GSS_HEADER_FIELD, oldGssHeaderField, gssHeaderField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case tmheaderoutputPackage.GSSTM_HEADER_OUTPUT_FIELD__GSS_HEADER_FIELD:
