 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filters.GSSFilterBoolVarRef#getIdRef <em>Id Ref</em>}</li>
 * </ul>
 *
 * @see es.uah.aut.srg.gss.filters.filtersPackage#getGSSFilterBoolVarRef()
 * @model
 * @generated
 */
public interface GSSFilterBoolVarRef extends EObject {
	 ...
	 * @see #setIdRef(String)
	 * @see es.uah.aut.srg.gss.filters.filtersPackage#getGSSFilterBoolVarRef_IdRef()
	 * @model required="true"
	 * @generated
	 */
	String getIdRef();
	...
	/**
	 * Sets the value of the '{@link es.uah.aut.srg.gss.filters.GSSFilterBoolVarRef#getIdRef <em>Id Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
