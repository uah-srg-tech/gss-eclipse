 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filters.GSSFilterMaxterm#getId <em>Id</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.GSSFilterMaxterm#getBoolVarRef <em>Bool Var Ref</em>}</li>
 * </ul>
 *
 * @see es.uah.aut.srg.gss.filters.filtersPackage#getGSSFilterMaxterm()
 * @model
 * @generated
 */
public interface GSSFilterMaxterm extends EObject {
	 ...
	 * @see #setId(String)
	 * @see es.uah.aut.srg.gss.filters.filtersPackage#getGSSFilterMaxterm_Id()
	 * @model required="true"
	 * @generated
	 */
	String getId();
	...
	/**
	 * Sets the value of the '{@link es.uah.aut.srg.gss.filters.GSSFilterMaxterm#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.uah.aut.srg.gss.filters.filtersPackage#getGSSFilterMaxterm_BoolVarRef()
