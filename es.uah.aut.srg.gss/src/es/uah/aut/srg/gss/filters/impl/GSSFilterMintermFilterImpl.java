 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterMintermFilterImpl#getFormatFile <em>Format File</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterMintermFilterImpl#getBoolVar <em>Bool Var</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterMintermFilterImpl#getBoolVarFromArrayItem <em>Bool Var From Array Item</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterMintermFilterImpl#getBoolVarFromGroupedArrayItem <em>Bool Var From Grouped Array Item</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterMintermFilterImpl#getBoolVarFDIC <em>Bool Var FDIC</em>}</li>
...
public class GSSFilterMintermFilterImpl extends GSSFilterFilterImpl implements GSSFilterMintermFilter {
	...
	public EList<GSSFilterBoolVar> getBoolVar() {
		if (boolVar == null) {
			boolVar = new EObjectContainmentEList<GSSFilterBoolVar>(GSSFilterBoolVar.class, this, filtersPackage.GSS_FILTER_MINTERM_FILTER__BOOL_VAR);
		}
		return boolVar;
	}
	...
	public EList<GSSFilterBoolVarFromArrayItem> getBoolVarFromArrayItem() {
		if (boolVarFromArrayItem == null) {
			boolVarFromArrayItem = new EObjectContainmentEList<GSSFilterBoolVarFromArrayItem>(GSSFilterBoolVarFromArrayItem.class, this, filtersPackage.GSS_FILTER_MINTERM_FILTER__BOOL_VAR_FROM_ARRAY_ITEM);
		}
	...
	public EList<GSSFilterBoolVarFromGroupedArrayItem> getBoolVarFromGroupedArrayItem() {
		if (boolVarFromGroupedArrayItem == null) {
			boolVarFromGroupedArrayItem = new EObjectContainmentEList<GSSFilterBoolVarFromGroupedArrayItem>(GSSFilterBoolVarFromGroupedArrayItem.class, this, filtersPackage.GSS_FILTER_MINTERM_FILTER__BOOL_VAR_FROM_GROUPED_ARRAY_ITEM);
		}
	...
	public EList<GSSFilterBoolVarFDIC> getBoolVarFDIC() {
		if (boolVarFDIC == null) {
			boolVarFDIC = new EObjectContainmentEList<GSSFilterBoolVarFDIC>(GSSFilterBoolVarFDIC.class, this, filtersPackage.GSS_FILTER_MINTERM_FILTER__BOOL_VAR_FDIC);
		}
		return boolVarFDIC;
	}
