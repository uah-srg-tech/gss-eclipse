 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterMaxtermImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterMaxtermImpl#getBoolVarRef <em>Bool Var Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSFilterMaxtermImpl extends MinimalEObjectImpl.Container implements GSSFilterMaxterm {
	...
	public EList<GSSFilterBoolVarRef> getBoolVarRef() {
		if (boolVarRef == null) {
			boolVarRef = new EObjectContainmentEList<GSSFilterBoolVarRef>(GSSFilterBoolVarRef.class, this, filtersPackage.GSS_FILTER_MAXTERM__BOOL_VAR_REF);
		}
		return boolVarRef;
	}
