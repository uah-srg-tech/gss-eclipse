 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterFilterImpl#getFormatFile <em>Format File</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterFilterImpl#getBoolVar <em>Bool Var</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterFilterImpl#getBoolVarFromArrayItem <em>Bool Var From Array Item</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterFilterImpl#getBoolVarFromGroupedArrayItem <em>Bool Var From Grouped Array Item</em>}</li>
 *   <li>{@link es.uah.aut.srg.gss.filters.impl.GSSFilterFilterImpl#getBoolVarFDIC <em>Bool Var FDIC</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GSSFilterFilterImpl extends GSSModelElementImpl implements GSSFilterFilter {
	...
	protected EClass eStaticClass() {
		return filtersPackage.Literals.GSS_FILTER_FILTER;
	}
		...
		if (formatFile != null && formatFile.eIsProxy()) {
			...
			if (formatFile != oldFormatFile) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, filtersPackage.GSS_FILTER_FILTER__FORMAT_FILE, oldFormatFile, formatFile));
			}
		}
		return formatFile;
	}
	...
	public void setFormatFile(GSSTmTcFormatTmTcFormat newFormatFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, filtersPackage.GSS_FILTER_FILTER__FORMAT_FILE, oldFormatFile, formatFile));
	}
	...
	public EList<GSSFilterBoolVar> getBoolVar() {
		if (boolVar == null) {
			boolVar = new EObjectContainmentEList<GSSFilterBoolVar>(GSSFilterBoolVar.class, this, filtersPackage.GSS_FILTER_FILTER__BOOL_VAR);
		}
		return boolVar;
	}
	...
	public EList<GSSFilterBoolVarFromArrayItem> getBoolVarFromArrayItem() {
		if (boolVarFromArrayItem == null) {
			boolVarFromArrayItem = new EObjectContainmentEList<GSSFilterBoolVarFromArrayItem>(GSSFilterBoolVarFromArrayItem.class, this, filtersPackage.GSS_FILTER_FILTER__BOOL_VAR_FROM_ARRAY_ITEM);
		}
	...
	public EList<GSSFilterBoolVarFromGroupedArrayItem> getBoolVarFromGroupedArrayItem() {
		if (boolVarFromGroupedArrayItem == null) {
			boolVarFromGroupedArrayItem = new EObjectContainmentEList<GSSFilterBoolVarFromGroupedArrayItem>(GSSFilterBoolVarFromGroupedArrayItem.class, this, filtersPackage.GSS_FILTER_FILTER__BOOL_VAR_FROM_GROUPED_ARRAY_ITEM);
		}
	...
	public EList<GSSFilterBoolVarFDIC> getBoolVarFDIC() {
		if (boolVarFDIC == null) {
			boolVarFDIC = new EObjectContainmentEList<GSSFilterBoolVarFDIC>(GSSFilterBoolVarFDIC.class, this, filtersPackage.GSS_FILTER_FILTER__BOOL_VAR_FDIC);
		}
		return boolVarFDIC;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case filtersPackage.GSS_FILTER_FILTER__BOOL_VAR:
				return ((InternalEList<?>)getBoolVar()).basicRemove(otherEnd, msgs);
			case filtersPackage.GSS_FILTER_FILTER__BOOL_VAR_FROM_ARRAY_ITEM:
				return ((InternalEList<?>)getBoolVarFromArrayItem()).basicRemove(otherEnd, msgs);
			case filtersPackage.GSS_FILTER_FILTER__BOOL_VAR_FROM_GROUPED_ARRAY_ITEM:
				return ((InternalEList<?>)getBoolVarFromGroupedArrayItem()).basicRemove(otherEnd, msgs);
			case filtersPackage.GSS_FILTER_FILTER__BOOL_VAR_FDIC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case filtersPackage.GSS_FILTER_FILTER__FORMAT_FILE:
