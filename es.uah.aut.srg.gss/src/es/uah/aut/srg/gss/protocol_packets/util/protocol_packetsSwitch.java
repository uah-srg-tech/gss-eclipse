 ...
 * @generated
 */
public class protocol_packetsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case protocol_packetsPackage.GSS_PROTOCOL_PACKETS_PROTOCOL_PACKETS: {
				GSSProtocolPacketsProtocolPackets gssProtocolPacketsProtocolPackets = (GSSProtocolPacketsProtocolPackets)theEObject;
				T result = caseGSSProtocolPacketsProtocolPackets(gssProtocolPacketsProtocolPackets);
				if (result == null) result = caseGSSModelElement(gssProtocolPacketsProtocolPackets);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GSS Protocol Packets Protocol Packets</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GSS Protocol Packets Protocol Packets</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGSSProtocolPacketsProtocolPackets(GSSProtocolPacketsProtocolPackets object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>GSS Protocol Packets Protocol Packet</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GSS Protocol Packets Protocol Packet</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
