...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GSSTC Header Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.gss.tcheader.impl.GSSTCHeaderFieldImpl#getGssHeaderField <em>Gss Header Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTCHeaderFieldImpl extends TMTCIFTCHeaderFieldImpl implements GSSTCHeaderField {
	/**
	 ...
	 * @generated
	 */
	protected GSSTCHeaderFieldImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return tcheaderPackage.Literals.GSSTC_HEADER_FIELD;
	}
		...
		if (gssHeaderField != null && gssHeaderField.eIsProxy()) {
			...
			if (gssHeaderField != oldGssHeaderField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, tcheaderPackage.GSSTC_HEADER_FIELD__GSS_HEADER_FIELD, oldGssHeaderField, gssHeaderField));
			}
		}
	...
	public void setGssHeaderField(GSSFormatField newGssHeaderField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tcheaderPackage.GSSTC_HEADER_FIELD__GSS_HEADER_FIELD, oldGssHeaderField, gssHeaderField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case tcheaderPackage.GSSTC_HEADER_FIELD__GSS_HEADER_FIELD:
