 ...
 *   <li>{@link es.uah.aut.srg.gss.tcheader.impl.GSSTCHeaderImpl#getGssHeaderFields <em>Gss Header Fields</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GSSTCHeaderImpl extends TMTCIFTCHeaderImpl implements GSSTCHeader {
	 ...
	 * @ordered
	 */
	protected EList<GSSTCHeaderField> gssHeaderFields;
	 ...
	 * @generated
	 */
	public EList<GSSTCHeaderField> getGssHeaderFields() {
		if (gssHeaderFields == null) {
			gssHeaderFields = new EObjectContainmentEList<GSSTCHeaderField>(GSSTCHeaderField.class, this, tcheaderPackage.GSSTC_HEADER__GSS_HEADER_FIELDS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case tcheaderPackage.GSSTC_HEADER__GSS_HEADER_FIELDS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case tcheaderPackage.GSSTC_HEADER__GSS_HEADER_FIELDS:
				...
				getGssHeaderFields().addAll((Collection<? extends GSSTCHeaderField>)newValue);
				return;
		}
	...
	public EList<TMTCIFTCHeaderField> getFields() {
		...
		for(GSSTCHeaderField gssField : getGssHeaderFields()) {
