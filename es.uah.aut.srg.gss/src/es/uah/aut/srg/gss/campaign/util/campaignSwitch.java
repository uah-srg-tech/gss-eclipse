 ...
 * @generated
 */
public class campaignSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case campaignPackage.GSS_CAMPAIGN_CAMPAIGN: {
				GSSCampaignCampaign gssCampaignCampaign = (GSSCampaignCampaign)theEObject;
				T result = caseGSSCampaignCampaign(gssCampaignCampaign);
				if (result == null) result = caseGSSModelElement(gssCampaignCampaign);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case campaignPackage.GSS_CAMPAIGN_SCENARIO: {
				GSSCampaignScenario gssCampaignScenario = (GSSCampaignScenario)theEObject;
				T result = caseGSSCampaignScenario(gssCampaignScenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GSS Campaign Campaign</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GSS Campaign Campaign</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGSSCampaignCampaign(GSSCampaignCampaign object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>GSS Campaign Scenario</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GSS Campaign Scenario</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
