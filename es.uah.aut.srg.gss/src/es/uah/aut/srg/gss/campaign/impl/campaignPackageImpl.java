...
public class campaignPackageImpl extends EPackageImpl implements campaignPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getGSSCampaignCampaign_Scenario(), theenvironmentPackage.getGSSEnvironmentScenario(), null, "scenario", null, 1, 1, GSSCampaignCampaign.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
