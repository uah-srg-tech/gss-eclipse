 ...
 ******************************************************************************/
package es.uah.aut.srg.gss.lang.tcheaderinput.services;
...
@Singleton
public class TCHEADERINPUTGrammarAccess extends AbstractGrammarElementFinder {
	
	public class GSSTCHeaderInputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheaderinput.TCHEADERINPUT.GSSTCHeaderInput");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cGSSTCHeaderInputKeyword_0 = (Keyword)cGroup.eContents().get(0);
		...
		private final RuleCall cGssHeaderFieldsGSSTCHeaderInputFieldParserRuleCall_8_1_0 = (RuleCall)cGssHeaderFieldsAssignment_8_1.eContents().get(0);
		private final Keyword cFieldsKeyword_8_2 = (Keyword)cGroup_8.eContents().get(2);
		private final Keyword cGSSTCHeaderInputKeyword_9 = (Keyword)cGroup.eContents().get(9);
		
		//GSSTCHeaderInput:
		//	'<GSSTCHeaderInput'
		//	'name=' name=STRING
		//	'>'
		//	'<format' 'file=' format=[format::GSSFormatFormat|STRING] '/>' ('<fields>' gssHeaderFields+=GSSTCHeaderInputField+
		//	'</fields>')?
		//	'</GSSTCHeaderInput>';
		@Override public ParserRule getRule() { return rule; }
		
		//'<GSSTCHeaderInput' 'name=' name=STRING '>' '<format' 'file=' format=[format::GSSFormatFormat|STRING] '/>' ('<fields>'
		//gssHeaderFields+=GSSTCHeaderInputField+ '</fields>')? '</GSSTCHeaderInput>'
		public Group getGroup() { return cGroup; }
		
		//'<GSSTCHeaderInput'
		public Keyword getGSSTCHeaderInputKeyword_0() { return cGSSTCHeaderInputKeyword_0; }
		...
		//('<fields>' gssHeaderFields+=GSSTCHeaderInputField+ '</fields>')?
		public Group getGroup_8() { return cGroup_8; }
		
		//'<fields>'
		public Keyword getFieldsKeyword_8_0() { return cFieldsKeyword_8_0; }
		
		//gssHeaderFields+=GSSTCHeaderInputField+
		public Assignment getGssHeaderFieldsAssignment_8_1() { return cGssHeaderFieldsAssignment_8_1; }
		
		//GSSTCHeaderInputField
		public RuleCall getGssHeaderFieldsGSSTCHeaderInputFieldParserRuleCall_8_1_0() { return cGssHeaderFieldsGSSTCHeaderInputFieldParserRuleCall_8_1_0; }
		
		//'</fields>'
		public Keyword getFieldsKeyword_8_2() { return cFieldsKeyword_8_2; }
		
		//'</GSSTCHeaderInput>'
		public Keyword getGSSTCHeaderInputKeyword_9() { return cGSSTCHeaderInputKeyword_9; }
	}
	public class GSSTCHeaderInputFieldElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheaderinput.TCHEADERINPUT.GSSTCHeaderInputField");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TMTCIFFieldValueRawElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheaderinput.TCHEADERINPUT.TMTCIFFieldValueRaw");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final GSSTCHeaderInputElements pGSSTCHeaderInput;
	private final GSSTCHeaderInputFieldElements pGSSTCHeaderInputField;
	...
	@Inject
	public TCHEADERINPUTGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pGSSTCHeaderInput = new GSSTCHeaderInputElements();
		this.pGSSTCHeaderInputField = new GSSTCHeaderInputFieldElements();
		this.pTMTCIFFieldValueRaw = new TMTCIFFieldValueRawElements();
		this.tUINT_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheaderinput.TCHEADERINPUT.UINT_STRING");
		this.tHEX_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tcheaderinput.TCHEADERINPUT.HEX_STRING");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("es.uah.aut.srg.gss.lang.tcheaderinput.TCHEADERINPUT".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	'</fields>')?
	//	'</GSSTCHeaderInput>';
	public GSSTCHeaderInputElements getGSSTCHeaderInputAccess() {
		return pGSSTCHeaderInput;
	}
	
	public ParserRule getGSSTCHeaderInputRule() {
		return getGSSTCHeaderInputAccess().getRule();
	}
	...
	//	'gssHeaderField=' gssHeaderField=[format::GSSFormatField|STRING] ('>' fieldValue=TMTCIFFieldValueRaw '</HeaderField>'
	//	| '/>');
	public GSSTCHeaderInputFieldElements getGSSTCHeaderInputFieldAccess() {
		return pGSSTCHeaderInputField;
	}
	
	public ParserRule getGSSTCHeaderInputFieldRule() {
		return getGSSTCHeaderInputFieldAccess().getRule();
	}
