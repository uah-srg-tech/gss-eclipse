 ...
 ******************************************************************************/
package es.uah.aut.srg.gss.lang.tmheaderoutput.services;
...
@Singleton
public class TMHEADEROUTPUTGrammarAccess extends AbstractGrammarElementFinder {
	
	public class GSSTMHeaderOutputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tmheaderoutput.TMHEADEROUTPUT.GSSTMHeaderOutput");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cGSSTMHeaderOutputKeyword_0 = (Keyword)cGroup.eContents().get(0);
		...
		private final RuleCall cGssHeaderFieldsGSSTMHeaderOutputFieldParserRuleCall_8_1_0 = (RuleCall)cGssHeaderFieldsAssignment_8_1.eContents().get(0);
		private final Keyword cFieldsKeyword_8_2 = (Keyword)cGroup_8.eContents().get(2);
		private final Keyword cGSSTMHeaderOutputKeyword_9 = (Keyword)cGroup.eContents().get(9);
		
		//GSSTMHeaderOutput:
		//	'<GSSTMHeaderOutput'
		//	'name=' name=STRING
		//	'>'
		//	'<format' 'file=' format=[format::GSSFormatFormat|STRING] '/>' ('<fields>' gssHeaderFields+=GSSTMHeaderOutputField+
		//	'</fields>')?
		//	'</GSSTMHeaderOutput>';
		@Override public ParserRule getRule() { return rule; }
		
		//'<GSSTMHeaderOutput' 'name=' name=STRING '>' '<format' 'file=' format=[format::GSSFormatFormat|STRING] '/>' ('<fields>'
		//gssHeaderFields+=GSSTMHeaderOutputField+ '</fields>')? '</GSSTMHeaderOutput>'
		public Group getGroup() { return cGroup; }
		
		//'<GSSTMHeaderOutput'
		public Keyword getGSSTMHeaderOutputKeyword_0() { return cGSSTMHeaderOutputKeyword_0; }
		...
		//('<fields>' gssHeaderFields+=GSSTMHeaderOutputField+ '</fields>')?
		public Group getGroup_8() { return cGroup_8; }
		
		//'<fields>'
		public Keyword getFieldsKeyword_8_0() { return cFieldsKeyword_8_0; }
		
		//gssHeaderFields+=GSSTMHeaderOutputField+
		public Assignment getGssHeaderFieldsAssignment_8_1() { return cGssHeaderFieldsAssignment_8_1; }
		
		//GSSTMHeaderOutputField
		public RuleCall getGssHeaderFieldsGSSTMHeaderOutputFieldParserRuleCall_8_1_0() { return cGssHeaderFieldsGSSTMHeaderOutputFieldParserRuleCall_8_1_0; }
		
		//'</fields>'
		public Keyword getFieldsKeyword_8_2() { return cFieldsKeyword_8_2; }
		
		//'</GSSTMHeaderOutput>'
		public Keyword getGSSTMHeaderOutputKeyword_9() { return cGSSTMHeaderOutputKeyword_9; }
	}
	public class GSSTMHeaderOutputFieldElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tmheaderoutput.TMHEADEROUTPUT.GSSTMHeaderOutputField");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TMTCIFFieldValueRawElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tmheaderoutput.TMHEADEROUTPUT.TMTCIFFieldValueRaw");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final GSSTMHeaderOutputElements pGSSTMHeaderOutput;
	private final GSSTMHeaderOutputFieldElements pGSSTMHeaderOutputField;
	...
	@Inject
	public TMHEADEROUTPUTGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pGSSTMHeaderOutput = new GSSTMHeaderOutputElements();
		this.pGSSTMHeaderOutputField = new GSSTMHeaderOutputFieldElements();
		this.pTMTCIFFieldValueRaw = new TMTCIFFieldValueRawElements();
		this.tUINT_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tmheaderoutput.TMHEADEROUTPUT.UINT_STRING");
		this.tHEX_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.gss.lang.tmheaderoutput.TMHEADEROUTPUT.HEX_STRING");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("es.uah.aut.srg.gss.lang.tmheaderoutput.TMHEADEROUTPUT".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	'</fields>')?
	//	'</GSSTMHeaderOutput>';
	public GSSTMHeaderOutputElements getGSSTMHeaderOutputAccess() {
		return pGSSTMHeaderOutput;
	}
	
	public ParserRule getGSSTMHeaderOutputRule() {
		return getGSSTMHeaderOutputAccess().getRule();
	}
	...
	//	'gssHeaderField=' gssHeaderField=[format::GSSFormatField|STRING] ('>' fieldValue=TMTCIFFieldValueRaw '</HeaderField>'
	//	| '/>');
	public GSSTMHeaderOutputFieldElements getGSSTMHeaderOutputFieldAccess() {
		return pGSSTMHeaderOutputField;
	}
	
	public ParserRule getGSSTMHeaderOutputFieldRule() {
		return getGSSTMHeaderOutputFieldAccess().getRule();
	}
