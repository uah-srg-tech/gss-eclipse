		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGSSScenarioGVAccess().getAlternatives(), "rule__GSSScenarioGV__Alternatives");
					...
					put(grammarAccess.getGSSScenarioPlotAccess().getGVAssignment_10(), "rule__GSSScenarioPlot__GVAssignment_10");
					...
					put(grammarAccess.getGSSScenarioAlarmMsgAccess().getGVAssignment_14(), "rule__GSSScenarioAlarmMsg__GVAssignment_14");
					...
					put(grammarAccess.getGSSScenarioModifyAccess().getGVAssignment_14(), "rule__GSSScenarioModify__GVAssignment_14");
					...
					put(grammarAccess.getGSSScenarioAlarmValAccess().getGVAssignment_10(), "rule__GSSScenarioAlarmVal__GVAssignment_10");
