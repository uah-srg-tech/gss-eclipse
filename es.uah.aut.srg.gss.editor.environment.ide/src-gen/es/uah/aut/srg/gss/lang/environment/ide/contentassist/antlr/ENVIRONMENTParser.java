		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGSSScenarioPeriodicTCAccess().getAlternatives(), "rule__GSSScenarioPeriodicTC__Alternatives");
					put(grammarAccess.getGSSScenarioReferenceAccess().getAlternatives(), "rule__GSSScenarioReference__Alternatives");
					put(grammarAccess.getGSSScenarioMonitorAccess().getAlternatives(), "rule__GSSScenarioMonitor__Alternatives");
					put(grammarAccess.getGSSScenarioGVRefAccess().getAlternatives(), "rule__GSSScenarioGVRef__Alternatives");
					...
					put(grammarAccess.getGSSEnvironmentEnvironmentAccess().getGroup(), "rule__GSSEnvironmentEnvironment__Group__0");
					put(grammarAccess.getGSSEnvironmentEnvironmentAccess().getGroup_3(), "rule__GSSEnvironmentEnvironment__Group_3__0");
					...
					put(grammarAccess.getGSSEnvironmentEnvironmentAccess().getNameAssignment_1(), "rule__GSSEnvironmentEnvironment__NameAssignment_1");
					put(grammarAccess.getGSSEnvironmentEnvironmentAccess().getUriAssignment_3_2(), "rule__GSSEnvironmentEnvironment__UriAssignment_3_2");
					put(grammarAccess.getGSSEnvironmentEnvironmentAccess().getVersionAssignment_6(), "rule__GSSEnvironmentEnvironment__VersionAssignment_6");
					put(grammarAccess.getGSSEnvironmentEnvironmentAccess().getScenarioAssignment_8(), "rule__GSSEnvironmentEnvironment__ScenarioAssignment_8");
					...
					put(grammarAccess.getGSSScenarioPeriodicTCsAccess().getPeriodicTCAssignment_3(), "rule__GSSScenarioPeriodicTCs__PeriodicTCAssignment_3");
					...
					put(grammarAccess.getGSSScenarioMonitorsAccess().getMonitorAssignment_3(), "rule__GSSScenarioMonitors__MonitorAssignment_3");
					...
					put(grammarAccess.getGSSScenarioGlobalVarAccess().getReferenceAssignment_18(), "rule__GSSScenarioGlobalVar__ReferenceAssignment_18");
					...
					put(grammarAccess.getGSSScenarioPlotAccess().getGVRefAssignment_10(), "rule__GSSScenarioPlot__GVRefAssignment_10");
					...
					put(grammarAccess.getGSSScenarioAlarmMsgAccess().getGVRefAssignment_14(), "rule__GSSScenarioAlarmMsg__GVRefAssignment_14");
					...
					put(grammarAccess.getGSSScenarioModifyAccess().getGVRefAssignment_14(), "rule__GSSScenarioModify__GVRefAssignment_14");
					...
					put(grammarAccess.getGSSScenarioAlarmValAccess().getGVRefAssignment_10(), "rule__GSSScenarioAlarmVal__GVRefAssignment_10");
