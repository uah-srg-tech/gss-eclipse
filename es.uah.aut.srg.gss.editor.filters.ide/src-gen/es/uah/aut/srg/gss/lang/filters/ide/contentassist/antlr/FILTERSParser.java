 ...
 ******************************************************************************/
package es.uah.aut.srg.gss.lang.filters.ide.contentassist.antlr;

import com.google.inject.Inject;
import es.uah.aut.srg.gss.lang.filters.ide.contentassist.antlr.internal.InternalFILTERSParser;
...
public class FILTERSParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalFILTERSParser createParser() {
		InternalFILTERSParser result = new InternalFILTERSParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGSSFilterBoolVarAccess().getAlternatives_16(), "rule__GSSFilterBoolVar__Alternatives_16");
					put(grammarAccess.getGSSFilterBoolVarFromArrayItemAccess().getAlternatives_16(), "rule__GSSFilterBoolVarFromArrayItem__Alternatives_16");
					put(grammarAccess.getGSSFilterBoolVarFromGroupedArrayItemAccess().getAlternatives_20(), "rule__GSSFilterBoolVarFromGroupedArrayItem__Alternatives_20");
					...
					put(grammarAccess.getGSSFilterFieldRefAccess().getGroup(), "rule__GSSFilterFieldRef__Group__0");
					...
					put(grammarAccess.getGSSFilterAIFieldRefAccess().getGroup(), "rule__GSSFilterAIFieldRef__Group__0");
					put(grammarAccess.getGSSFilterAIFieldRefsAccess().getGroup(), "rule__GSSFilterAIFieldRefs__Group__0");
					...
					put(grammarAccess.getGSSFilterBoolVarAccess().getFieldRefAssignment_14(), "rule__GSSFilterBoolVar__FieldRefAssignment_14");
					put(grammarAccess.getGSSFilterBoolVarAccess().getOpAssignment_15(), "rule__GSSFilterBoolVar__OpAssignment_15");
					put(grammarAccess.getGSSFilterBoolVarAccess().getConstantAssignment_16_0(), "rule__GSSFilterBoolVar__ConstantAssignment_16_0");
					put(grammarAccess.getGSSFilterBoolVarAccess().getSelectAssignment_16_1(), "rule__GSSFilterBoolVar__SelectAssignment_16_1");
					put(grammarAccess.getGSSFilterBoolVarAccess().getSelectLineAssignment_16_2(), "rule__GSSFilterBoolVar__SelectLineAssignment_16_2");
					...
					put(grammarAccess.getGSSFilterBoolVarFromArrayItemAccess().getAIFieldRefAssignment_14(), "rule__GSSFilterBoolVarFromArrayItem__AIFieldRefAssignment_14");
					put(grammarAccess.getGSSFilterBoolVarFromArrayItemAccess().getOpAssignment_15(), "rule__GSSFilterBoolVarFromArrayItem__OpAssignment_15");
					put(grammarAccess.getGSSFilterBoolVarFromArrayItemAccess().getConstantAssignment_16_0(), "rule__GSSFilterBoolVarFromArrayItem__ConstantAssignment_16_0");
					put(grammarAccess.getGSSFilterBoolVarFromArrayItemAccess().getSelectAssignment_16_1(), "rule__GSSFilterBoolVarFromArrayItem__SelectAssignment_16_1");
					put(grammarAccess.getGSSFilterBoolVarFromArrayItemAccess().getSelectLineAssignment_16_2(), "rule__GSSFilterBoolVarFromArrayItem__SelectLineAssignment_16_2");
					...
					put(grammarAccess.getGSSFilterBoolVarFromGroupedArrayItemAccess().getAIFieldRefsAssignment_18(), "rule__GSSFilterBoolVarFromGroupedArrayItem__AIFieldRefsAssignment_18");
					put(grammarAccess.getGSSFilterBoolVarFromGroupedArrayItemAccess().getOpAssignment_19(), "rule__GSSFilterBoolVarFromGroupedArrayItem__OpAssignment_19");
					put(grammarAccess.getGSSFilterBoolVarFromGroupedArrayItemAccess().getConstantAssignment_20_0(), "rule__GSSFilterBoolVarFromGroupedArrayItem__ConstantAssignment_20_0");
					put(grammarAccess.getGSSFilterBoolVarFromGroupedArrayItemAccess().getSelectAssignment_20_1(), "rule__GSSFilterBoolVarFromGroupedArrayItem__SelectAssignment_20_1");
					put(grammarAccess.getGSSFilterBoolVarFromGroupedArrayItemAccess().getSelectLineAssignment_20_2(), "rule__GSSFilterBoolVarFromGroupedArrayItem__SelectLineAssignment_20_2");
					...
					put(grammarAccess.getGSSFilterBoolVarFDICAccess().getFieldRefAssignment_10(), "rule__GSSFilterBoolVarFDIC__FieldRefAssignment_10");
					put(grammarAccess.getGSSFilterBoolVarFDICAccess().getOpAssignment_11(), "rule__GSSFilterBoolVarFDIC__OpAssignment_11");
					put(grammarAccess.getGSSFilterFieldRefAccess().getNameAssignment_4(), "rule__GSSFilterFieldRef__NameAssignment_4");
					...
					put(grammarAccess.getGSSFilterAIFieldRefAccess().getIndexAssignment_4(), "rule__GSSFilterAIFieldRef__IndexAssignment_4");
					put(grammarAccess.getGSSFilterAIFieldRefsAccess().getNameAssignment_4(), "rule__GSSFilterAIFieldRefs__NameAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalFILTERSParser typedParser = (InternalFILTERSParser) parser;
