...
import es.uah.aut.srg.gss.lang.config.parser.antlr.CONFIGAntlrTokenFileProvider;
import es.uah.aut.srg.gss.lang.config.parser.antlr.CONFIGParser;
import es.uah.aut.srg.gss.lang.config.parser.antlr.internal.InternalCONFIGLexer;
import es.uah.aut.srg.gss.lang.config.scoping.CONFIGScopeProvider;
import es.uah.aut.srg.gss.lang.config.serializer.CONFIGSemanticSequencer;
import es.uah.aut.srg.gss.lang.config.serializer.CONFIGSyntacticSequencer;
import es.uah.aut.srg.gss.lang.config.services.CONFIGGrammarAccess;
import es.uah.aut.srg.gss.lang.config.validation.CONFIGValidator;
...
public abstract class AbstractCONFIGRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "es/uah/aut/srg/gss/lang/config/CONFIG.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("es.uah.aut.srg.gss.lang.config.CONFIG");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("gss_config");
	}
