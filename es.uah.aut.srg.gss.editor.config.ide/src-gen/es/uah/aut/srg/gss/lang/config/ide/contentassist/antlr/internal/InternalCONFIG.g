...
:
(
	{ before(grammarAccess.getGSSConfigGSSConfigAccess().getScenarioAssignment_8()); }
	(rule__GSSConfigGSSConfig__ScenarioAssignment_8)
	{ after(grammarAccess.getGSSConfigGSSConfigAccess().getScenarioAssignment_8()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getGSSConfigGSSConfigAccess().getTestsAssignment_9()); }
	(rule__GSSConfigGSSConfig__TestsAssignment_9)
	{ after(grammarAccess.getGSSConfigGSSConfigAccess().getTestsAssignment_9()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleGSSScenarioScenario
		{ after(grammarAccess.getGSSConfigGSSConfigAccess().getScenarioGSSScenarioScenarioParserRuleCall_8_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getGSSConfigGSSConfigAccess().getTestsGSSTestListTestListParserRuleCall_9_0()); }
		ruleGSSTestListTestList
		{ after(grammarAccess.getGSSConfigGSSConfigAccess().getTestsGSSTestListTestListParserRuleCall_9_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
