		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGSSConfigInterfacesAccess().getGroup_2(), "rule__GSSConfigInterfaces__Group_2__0");
					...
					put(grammarAccess.getGSSConfigInterfacesAccess().getProtocolPacketsFileAssignment_2_2(), "rule__GSSConfigInterfaces__ProtocolPacketsFileAssignment_2_2");
					put(grammarAccess.getGSSConfigInterfacesAccess().getMainInterfaceAssignment_3(), "rule__GSSConfigInterfaces__MainInterfaceAssignment_3");
					put(grammarAccess.getGSSConfigInterfacesAccess().getInterfaceAssignment_4(), "rule__GSSConfigInterfaces__InterfaceAssignment_4");
