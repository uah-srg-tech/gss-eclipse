		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGSSConfigSpecialPacketAccess().getAlternatives_29(), "rule__GSSConfigSpecialPacket__Alternatives_29");
					...
					put(grammarAccess.getGSSConfigTMFormatAccess().getGroup(), "rule__GSSConfigTMFormat__Group__0");
					put(grammarAccess.getGSSConfigTCFormatAccess().getGroup(), "rule__GSSConfigTCFormat__Group__0");
					put(grammarAccess.getGSSConfigInputFilterAccess().getGroup(), "rule__GSSConfigInputFilter__Group__0");
					put(grammarAccess.getGSSConfigExportToPrevLevelAccess().getGroup(), "rule__GSSConfigExportToPrevLevel__Group__0");
					put(grammarAccess.getGSSConfigImportFromPrevLevelAccess().getGroup(), "rule__GSSConfigImportFromPrevLevel__Group__0");
					...
					put(grammarAccess.getGSSConfigLevel2Access().getGroup(), "rule__GSSConfigLevel2__Group__0");
					put(grammarAccess.getGSSConfigLevel1Access().getGroup(), "rule__GSSConfigLevel1__Group__0");
					put(grammarAccess.getGSSConfigLevel0Access().getGroup(), "rule__GSSConfigLevel0__Group__0");
					put(grammarAccess.getGSSConfigAppToLevel2Access().getGroup(), "rule__GSSConfigAppToLevel2__Group__0");
					put(grammarAccess.getGSSConfigAppToLevel1Access().getGroup(), "rule__GSSConfigAppToLevel1__Group__0");
					put(grammarAccess.getGSSConfigAppToLevel0Access().getGroup(), "rule__GSSConfigAppToLevel0__Group__0");
					put(grammarAccess.getGSSConfigLevel2ToLevel1Access().getGroup(), "rule__GSSConfigLevel2ToLevel1__Group__0");
					put(grammarAccess.getGSSConfigLevel1ToLevel0Access().getGroup(), "rule__GSSConfigLevel1ToLevel0__Group__0");
					...
					put(grammarAccess.getGSSConfigLevelInOutAccess().getTMformatAssignment_10(), "rule__GSSConfigLevelInOut__TMformatAssignment_10");
					put(grammarAccess.getGSSConfigLevelInOutAccess().getTCformatAssignment_11(), "rule__GSSConfigLevelInOut__TCformatAssignment_11");
					put(grammarAccess.getGSSConfigLevelInOutAccess().getInputFilterAssignment_12(), "rule__GSSConfigLevelInOut__InputFilterAssignment_12");
					put(grammarAccess.getGSSConfigLevelInOutAccess().getExport_to_prev_LevelAssignment_13(), "rule__GSSConfigLevelInOut__Export_to_prev_LevelAssignment_13");
					put(grammarAccess.getGSSConfigLevelInOutAccess().getImport_from_prev_LevelAssignment_14(), "rule__GSSConfigLevelInOut__Import_from_prev_LevelAssignment_14");
					...
					put(grammarAccess.getGSSConfigLevelInAccess().getTCformatAssignment_10(), "rule__GSSConfigLevelIn__TCformatAssignment_10");
					put(grammarAccess.getGSSConfigLevelInAccess().getExport_to_prev_LevelAssignment_11(), "rule__GSSConfigLevelIn__Export_to_prev_LevelAssignment_11");
					...
					put(grammarAccess.getGSSConfigLevelOutAccess().getTMformatAssignment_10(), "rule__GSSConfigLevelOut__TMformatAssignment_10");
					put(grammarAccess.getGSSConfigLevelOutAccess().getInputFilterAssignment_11(), "rule__GSSConfigLevelOut__InputFilterAssignment_11");
					put(grammarAccess.getGSSConfigLevelOutAccess().getImport_from_prev_LevelAssignment_12(), "rule__GSSConfigLevelOut__Import_from_prev_LevelAssignment_12");
					put(grammarAccess.getGSSConfigTMFormatAccess().getFileAssignment_4(), "rule__GSSConfigTMFormat__FileAssignment_4");
					put(grammarAccess.getGSSConfigTCFormatAccess().getFileAssignment_4(), "rule__GSSConfigTCFormat__FileAssignment_4");
					put(grammarAccess.getGSSConfigInputFilterAccess().getFileAssignment_4(), "rule__GSSConfigInputFilter__FileAssignment_4");
					put(grammarAccess.getGSSConfigExportToPrevLevelAccess().getFileAssignment_4(), "rule__GSSConfigExportToPrevLevel__FileAssignment_4");
					put(grammarAccess.getGSSConfigImportFromPrevLevelAccess().getFileAssignment_4(), "rule__GSSConfigImportFromPrevLevel__FileAssignment_4");
					...
					put(grammarAccess.getGSSConfigSpecialPacketAccess().getInputFilterAssignment_26(), "rule__GSSConfigSpecialPacket__InputFilterAssignment_26");
					put(grammarAccess.getGSSConfigSpecialPacketAccess().getUpperLevelsAssignment_27(), "rule__GSSConfigSpecialPacket__UpperLevelsAssignment_27");
					put(grammarAccess.getGSSConfigSpecialPacketAccess().getPrintingDataAssignment_28(), "rule__GSSConfigSpecialPacket__PrintingDataAssignment_28");
					put(grammarAccess.getGSSConfigSpecialPacketAccess().getPeriodAssignment_29_0(), "rule__GSSConfigSpecialPacket__PeriodAssignment_29_0");
					put(grammarAccess.getGSSConfigSpecialPacketAccess().getIntervalRangeAssignment_29_1(), "rule__GSSConfigSpecialPacket__IntervalRangeAssignment_29_1");
					...
					put(grammarAccess.getGSSConfigUpperLevelAccess().getTMformatAssignment_6(), "rule__GSSConfigUpperLevel__TMformatAssignment_6");
					put(grammarAccess.getGSSConfigUpperLevelAccess().getInputFilterAssignment_7(), "rule__GSSConfigUpperLevel__InputFilterAssignment_7");
					put(grammarAccess.getGSSConfigUpperLevelAccess().getImport_from_prev_LevelAssignment_8(), "rule__GSSConfigUpperLevel__Import_from_prev_LevelAssignment_8");
					...
					put(grammarAccess.getGSSConfigPeriodicTCLevel2Access().getLevel2Assignment_22(), "rule__GSSConfigPeriodicTCLevel2__Level2Assignment_22");
					put(grammarAccess.getGSSConfigPeriodicTCLevel2Access().getApp_to_level2Assignment_23(), "rule__GSSConfigPeriodicTCLevel2__App_to_level2Assignment_23");
					put(grammarAccess.getGSSConfigPeriodicTCLevel2Access().getLevel1Assignment_24(), "rule__GSSConfigPeriodicTCLevel2__Level1Assignment_24");
					put(grammarAccess.getGSSConfigPeriodicTCLevel2Access().getLevel2_to_level1Assignment_25(), "rule__GSSConfigPeriodicTCLevel2__Level2_to_level1Assignment_25");
					put(grammarAccess.getGSSConfigPeriodicTCLevel2Access().getLevel0Assignment_26(), "rule__GSSConfigPeriodicTCLevel2__Level0Assignment_26");
					put(grammarAccess.getGSSConfigPeriodicTCLevel2Access().getLevel1_to_level0Assignment_27(), "rule__GSSConfigPeriodicTCLevel2__Level1_to_level0Assignment_27");
					...
					put(grammarAccess.getGSSConfigPeriodicTCLevel1Access().getLevel1Assignment_22(), "rule__GSSConfigPeriodicTCLevel1__Level1Assignment_22");
					put(grammarAccess.getGSSConfigPeriodicTCLevel1Access().getApp_to_level1Assignment_23(), "rule__GSSConfigPeriodicTCLevel1__App_to_level1Assignment_23");
					put(grammarAccess.getGSSConfigPeriodicTCLevel1Access().getLevel0Assignment_24(), "rule__GSSConfigPeriodicTCLevel1__Level0Assignment_24");
					put(grammarAccess.getGSSConfigPeriodicTCLevel1Access().getLevel1_to_level0Assignment_25(), "rule__GSSConfigPeriodicTCLevel1__Level1_to_level0Assignment_25");
					...
					put(grammarAccess.getGSSConfigPeriodicTCLevel0Access().getLevel0Assignment_22(), "rule__GSSConfigPeriodicTCLevel0__Level0Assignment_22");
					put(grammarAccess.getGSSConfigPeriodicTCLevel0Access().getApp_to_level0Assignment_23(), "rule__GSSConfigPeriodicTCLevel0__App_to_level0Assignment_23");
					put(grammarAccess.getGSSConfigLevel2Access().getFormatAssignment_4(), "rule__GSSConfigLevel2__FormatAssignment_4");
					put(grammarAccess.getGSSConfigLevel1Access().getFormatAssignment_4(), "rule__GSSConfigLevel1__FormatAssignment_4");
					put(grammarAccess.getGSSConfigLevel0Access().getFormatAssignment_4(), "rule__GSSConfigLevel0__FormatAssignment_4");
					put(grammarAccess.getGSSConfigAppToLevel2Access().getExportAssignment_4(), "rule__GSSConfigAppToLevel2__ExportAssignment_4");
					put(grammarAccess.getGSSConfigAppToLevel1Access().getExportAssignment_4(), "rule__GSSConfigAppToLevel1__ExportAssignment_4");
					put(grammarAccess.getGSSConfigAppToLevel0Access().getExportAssignment_4(), "rule__GSSConfigAppToLevel0__ExportAssignment_4");
					put(grammarAccess.getGSSConfigLevel2ToLevel1Access().getExportAssignment_4(), "rule__GSSConfigLevel2ToLevel1__ExportAssignment_4");
					put(grammarAccess.getGSSConfigLevel1ToLevel0Access().getExportAssignment_4(), "rule__GSSConfigLevel1ToLevel0__ExportAssignment_4");
					...
					put(grammarAccess.getGSSConfigGVFilteredAccess().getFilterAssignment_8(), "rule__GSSConfigGVFiltered__FilterAssignment_8");
