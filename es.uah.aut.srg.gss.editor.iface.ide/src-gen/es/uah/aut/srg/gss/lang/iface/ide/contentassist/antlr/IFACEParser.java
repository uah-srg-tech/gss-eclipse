		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGSSIfacePortProtocolUnitAccess().getAlternatives(), "rule__GSSIfacePortProtocolUnit__Alternatives");
					put(grammarAccess.getGSSIfacePortProtocolPowerAccess().getAlternatives(), "rule__GSSIfacePortProtocolPower__Alternatives");
					...
					put(grammarAccess.getGSSIfaceSocketSrvPortAccess().getGroup(), "rule__GSSIfaceSocketSrvPort__Group__0");
					put(grammarAccess.getGSSIfaceSocketCliPortAccess().getGroup(), "rule__GSSIfaceSocketCliPort__Group__0");
					put(grammarAccess.getGSSIfacePortProtocolAccess().getGroup(), "rule__GSSIfacePortProtocol__Group__0");
					...
					put(grammarAccess.getGSSIfaceUartPortAccess().getPortProtocolAssignment_26(), "rule__GSSIfaceUartPort__PortProtocolAssignment_26");
					put(grammarAccess.getGSSIfaceSocketSrvPortAccess().getPortNumberAssignment_4(), "rule__GSSIfaceSocketSrvPort__PortNumberAssignment_4");
					put(grammarAccess.getGSSIfaceSocketSrvPortAccess().getPortProtocolAssignment_6(), "rule__GSSIfaceSocketSrvPort__PortProtocolAssignment_6");
					put(grammarAccess.getGSSIfaceSocketCliPortAccess().getIpAddressAssignment_4(), "rule__GSSIfaceSocketCliPort__IpAddressAssignment_4");
					put(grammarAccess.getGSSIfaceSocketCliPortAccess().getPortNumberAssignment_8(), "rule__GSSIfaceSocketCliPort__PortNumberAssignment_8");
					put(grammarAccess.getGSSIfaceSocketCliPortAccess().getPortProtocolAssignment_10(), "rule__GSSIfaceSocketCliPort__PortProtocolAssignment_10");
					put(grammarAccess.getGSSIfacePortProtocolAccess().getUnitAssignment_4(), "rule__GSSIfacePortProtocol__UnitAssignment_4");
					put(grammarAccess.getGSSIfacePortProtocolAccess().getPowerAssignment_8(), "rule__GSSIfacePortProtocol__PowerAssignment_8");
					put(grammarAccess.getGSSIfacePortProtocolAccess().getConstSizeAssignment_10(), "rule__GSSIfacePortProtocol__ConstSizeAssignment_10");
					put(grammarAccess.getGSSIfacePortProtocolAccess().getSizeFieldOffsetAssignment_11(), "rule__GSSIfacePortProtocol__SizeFieldOffsetAssignment_11");
					put(grammarAccess.getGSSIfacePortProtocolAccess().getSizeFieldTrimAssignment_12(), "rule__GSSIfacePortProtocol__SizeFieldTrimAssignment_12");
					put(grammarAccess.getGSSIfacePortProtocolAccess().getSyncPatternAssignment_13(), "rule__GSSIfacePortProtocol__SyncPatternAssignment_13");
